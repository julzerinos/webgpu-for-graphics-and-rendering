...
`,ct="drawing",lt="drawing-mode",Ya=["POINT","TRIANGLE","CIRCLE"],lr="points-color",fr="drawing-background-color",ur="granularity-slider",dr="size-slider",hr="clear",Xa=async()=>{const{device:n,canvas:e,context:t,canvasFormat:r}=await cn(ct);let i=An(fr,T=>{i=T,V()});const a=ot("display-draw-instruction"),o=k(lr),s=k(lt),c=k(ur),l=k(dr),d=1e3,f=new Float32Array(6*d*Gn.float32x2),{buffer:h,bufferLayout:_}=H(n,f,"float32x2"),p=new Float32Array(6*d*Gn.float32x3),{buffer:v,bufferLayout:g}=H(n,p,"float32x3",1),L=nn(n,[_,g],r,$a,"triangle-list");ki(ct,T=>{switch(s()){case"TRIANGLE":F(T);break;case"CIRCLE":E(T);break;default:case"POINT":S(),A(T);break}V()});let m=0,w=0;const A=({x:T,y:q})=>{const tn=oe(T,0,e.width,-1,1),an=-1*oe(q,0,e.height,-1,1),U=be(y(tn,an),l()/e.height),Y=new Float32Array(B(U));n.queue.writeBuffer(h,m,Y),m+=6*Gn.float32x2;const X=Array(6).fill(et(he(o()))),C=new Float32Array(B(X));n.queue.writeBuffer(v,w,C),w+=6*Gn.float32x3};let x=[],P=[];const S=()=>{x=[],P=[]},F=T=>{if(x.push(T),P.push(o()),P.length<3){A(T);return}const q=new Float32Array([].concat(...x.map(({x:an,y:U})=>{const Y=oe(an,0,e.width,-1,1),X=-1*oe(U,0,e.height,-1,1);return y(Y,X)}),B(Array(9).fill(y()))));n.queue.writeBuffer(h,m-2*6*Gn.float32x2,q),m+=Gn.float32x2*(3-2*6);const tn=new Float32Array([].concat(...B(P.map(an=>et(he(an)))),B(Array(9).fill(b()))));n.queue.writeBuffer(v,w-2*6*Gn.float32x3,tn),w+=Gn.float32x3*(3-2*6),S()},E=T=>{if(x.push(T),P.push(o()),x.length<2){A(T);return}const q=y(oe(x[0].x,0,e.width,-1,1),-1*oe(x[0].y,0,e.height,-1,1)),tn=y(oe(x[1].x,0,e.width,-1,1),-1*oe(x[1].y,0,e.height,-1,1)),an=Ct(_e(tn,q)),U=Di(q,an,c()),Y=new Float32Array(B(U));n.queue.writeBuffer(h,m-6*Gn.float32x2,Y),m+=Gn.float32x2*(U.length-6);const X=new Float32Array(B([...new Array(U.length)].map((C,$)=>{const Q=$%3===0?0:1;return et(he(P[Q]))})));n.queue.writeBuffer(v,w-6*Gn.float32x3,X),w+=Gn.float32x3*(U.length-6),S()},V=()=>{const{pass:T,executePass:q}=un(n,t,he(i));T.setPipeline(L),T.setVertexBuffer(0,h),T.setVertexBuffer(1,v),T.draw(6*d),q()};Mt(hr,()=>{n.queue.writeBuffer(h,0,new Float32Array(6*d*Gn.float32x2)),n.queue.writeBuffer(v,0,new Float32Array(6*d*Gn.float32x3)),V()}),An(lt,T=>{a({POINT:"Click to create a point",TRIANGLE:"Create three points to form a triangle",CIRCLE:"Create two points to form a circle"}[T])}),a("Click to create a point"),V()},Wa=(n,e)=>{const t=sn("Drawing with WebGPU"),r=on(`
...
`),i=rn(),a=en(ct),o=_n(),s=it("display-draw-instruction"),c=Fn(lt,Ya),l=O(He(lr,"#000000"),"Draw color"),d=O(He(fr,"#ffffff"),"Background color"),f=O(fn(dr,10,2,100),"Point size"),h=O(fn(ur,12,4,32),"Circle granularity"),_=Ft(hr,"Clear canvas");o.append(s,c,l,f,h,d,_),i.append(a,o),n.append(t,r,i),e.push(Xa)},Ja=`struct Uniforms {
    mvp : mat4x4f,
};
...
`,Sr="earth",go=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Sr),{textureData:i,width:a,height:o}=await le(ce("textures/earth.jpg")),s=Gt(7),{buffer:c}=Vn(n,new Uint32Array(B(s.triangleIndices.map(X=>Sn(X))))),{buffer:l,bufferLayout:d}=H(n,new Float32Array(B(s.vertices)),"float32x4"),{buffer:f,bufferLayout:h}=H(n,new Float32Array(B([u(1,0,0),u(0,1,0),u(0,0,1),u(1,1,1),...new Array(s.vertices.length-4).fill(u(.4,.4,.4))])),"float32x4",1),_=4,{multisample:p,msaaTexture:v}=me(n,r,t,_),{depthStencil:g,depthStencilAttachmentFactory:L}=ie(n,r,_),I=nn(n,[d,h],t,mo,"triangle-list",{multisample:p,depthStencil:g}),{sampler:m,texture:w}=Zn(n,i,a,o,{minFilter:"nearest",magFilter:"nearest"}),A=Un(n,I,w,m,1),x=Nn(0),P=b(3*Math.sin(x),0,3*Math.cos(x)),S=b(0),F=b(0,1,0),E=Cn(P,S,F),R=te(45,r.width/r.height,.1,100),q=M(R,E),{bindGroup:tn,buffers:[an]}=z(n,I,[new Float32Array(K(q))],"UNIFORM",0),U=X=>{const C=Nn(X),$=b(3*Math.sin(C),Math.cos(C),3*Math.cos(C)),Q=Cn($,S,F),bn=M(R,Q);W(n,an,new Float32Array(K(bn)),0)},Y=X=>{U(X/50);const{pass:C,executePass:$}=un(n,e,u(.5,.1,.5),{depthStencilAttachmentFactory:L,msaaTexture:v});C.setPipeline(I),C.setVertexBuffer(0,l),C.setVertexBuffer(1,f),C.setIndexBuffer(c,"uint32"),C.setBindGroup(0,tn),C.setBindGroup(1,A),C.drawIndexed(s.triangleCount*3),$(),requestAnimationFrame(Y)};requestAnimationFrame(Y)},xo=(n,e)=>{const t=sn("Earth ball"),r=on(`
...
`,Tr="texture-sphere-with-quad",Br="env-sphere-reflect-type",Rr={"Faux reflection":0,"Mirror reflection":1,"Show normal map":2,"Bump reflection":3},wo=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Tr),[i,...a]=await Promise.all(["textures/normalmap.png","textures/cubemap/cm_left.png","textures/cubemap/cm_right.png","textures/cubemap/cm_top.png","textures/cubemap/cm_bottom.png","textures/cubemap/cm_back.png","textures/cubemap/cm_front.png"].map(Ln=>le(ce(Ln)))),o=b(0,0,3),s=b(0),c=b(0,1,0),l=Cn(o,s,c),f=te(90,r.width/r.height,.1,100),h=M(f,l),_=Ht(f),p=Ht(l),v=Wi(p,[0,0],[3,3]),g=zn(),L=Ji(v,g),I=M(L,_),m=Gt(7),w=B(m.triangleIndices.map(Ln=>Sn(Ln))),A=B(m.vertices.map(Ln=>Fe(Ln,h))),x=.999,P=B([u(-1,-1,x,1),u(1,-1,x,1),u(-1,1,x,1),u(1,1,x,1)]),S=[m.vertices.length+0,m.vertices.length+1,m.vertices.length+2,m.vertices.length+1,m.vertices.length+3,m.vertices.length+2],{buffer:F}=Vn(n,new Uint32Array([...w,...S])),{buffer:E,bufferLayout:V}=H(n,new Float32Array([...A,...P]),"float32x4"),{buffer:R,bufferLayout:T}=H(n,new Float32Array([...B(m.vertices),...P]),"float32x4",1),{buffer:q,bufferLayout:tn}=H(n,new Float32Array([...Array(m.vertices.length).fill(0),...Array(4).fill(1)]),"uint32",2),an=4,{multisample:U,msaaTexture:Y}=me(n,r,t,an),{depthStencil:X,depthStencilAttachmentFactory:C}=ie(n,r,an),$=nn(n,[V,T,tn],t,yo,"triangle-list",{multisample:U,depthStencil:X}),{sampler:Q,cubemapTexture:mn}=Fa(n,a.map(Ln=>Ln.textureData),a[0].width,a[0].height),bn=Un(n,$,mn,Q,0,{createViewOverwrite:{dimension:"cube"}}),{bindGroup:Z,buffers:[ln,dn,N]}=z(n,$,[new Float32Array(we([wn(),I])),new Float32Array([...o]),new Uint32Array([0])],"UNIFORM",1),{texture:j,sampler:Mn}=Zn(n,i.textureData,i.width,i.height),gn=Un(n,$,j,Mn,2),En=Ln=>{const $n=Rr[Ln];kn(n,N,new Uint32Array([$n]),0);const{pass:In,executePass:hn}=un(n,e,u(.5,.1,.5),{depthStencilAttachmentFactory:C,msaaTexture:Y});In.setPipeline($),In.setVertexBuffer(0,E),In.setVertexBuffer(1,R),In.setVertexBuffer(2,q),In.setIndexBuffer(F,"uint32"),In.setBindGroup(0,bn),In.setBindGroup(1,Z),In.setBindGroup(2,gn),In.drawIndexed(m.triangleCount*3+S.length),hn()};En(An(Br,En))},Lo=(n,e)=>{const t=sn("A map to the environment"),r=on(`
...
`,qo={[J.NORTH]:J.SOUTH,[J.EAST]:J.WEST,[J.SOUTH]:J.NORTH,[J.WEST]:J.EAST},Gr=n=>{const e=[];n&J.NORTH&&e.push(J.NORTH),n&J.EAST&&e.push(J.EAST),n&J.SOUTH&&e.push(J.SOUTH),n&J.WEST&&e.push(J.WEST);const t=Math.round(Math.random()*e.length-.5);return e[t]},kr={1:y(0,1),2:y(1,0),4:y(0,-1),8:y(-1,0)},Lt={[J.NORTH]:u(0,0,1,0),[J.EAST]:u(1,0,0,0),[J.SOUTH]:u(0,0,-1,0),[J.WEST]:u(-1,0,0,0)},Xn=12,ne=(n,e,t)=>{n[e[0]][e[1]]=t},Je=(n,e)=>e[1]>=0&&e[1]<Xn&&e[0]>=0&&e[0]<Xn?n[e[0]][e[1]]:xn.OUT_OF_BOUNDS,Ue=(n,e)=>Je(n,e)===xn.EMPTY,Yn=(n,e)=>{const t=Je(n,e);return t===xn.EMPTY||t===xn.OUT_OF_BOUNDS},$o=(n,e,t)=>{switch(t){case J.NORTH:return Yn(n,G(e,y(-1,1)))&&Ue(n,G(e,y(0,1)))&&Yn(n,G(e,y(1,1)));case J.EAST:return Yn(n,G(e,y(1,1)))&&Ue(n,G(e,y(1,0)))&&Yn(n,G(e,y(1,-1)));case J.SOUTH:return Yn(n,G(e,y(-1,-1)))&&Ue(n,G(e,y(0,-1)))&&Yn(n,G(e,y(1,-1)));case J.WEST:return Yn(n,G(e,y(-1,1)))&&Ue(n,G(e,y(-1,0)))&&Yn(n,G(e,y(-1,-1)))}return!1},Yo=(n,e)=>{const t=!Yn(n,G(e,y(0,1)))&&!Yn(n,G(e,y(0,-1))),r=!Yn(n,G(e,y(1,0)))&&!Yn(n,G(e,y(-1,0)));return t||r},Xo=()=>Math.random()<.15?xn.LIGHT:xn.NORMAL,Wo=(n,e)=>(ne(n,G(e,y(1,0)),xn.NORMAL),ne(n,G(e,y(0,0)),xn.SPAWN),ne(n,G(e,y(-1,0)),xn.NORMAL),ne(n,G(e,y(1,1)),xn.LIGHT),ne(n,G(e,y(0,1)),xn.NORMAL),ne(n,G(e,y(-1,1)),xn.LIGHT),ne(n,G(e,y(1,2)),xn.NORMAL),ne(n,G(e,y(0,2)),xn.NORMAL),ne(n,G(e,y(-1,2)),xn.NORMAL),G(e,y(0,3))),Jo=()=>{const n=Array.from(Array(Xn).fill(null),()=>Array(Xn).fill(xn.EMPTY)),e=y(Xn/2,Xn/2),t=Wo(n,e);let r=!1;const i=a=>{const o=Yo(n,a),s=Xo();if(s===xn.EMPTY||o)return;ne(n,a,s);let c=0;const l=[J.NORTH,J.EAST,J.SOUTH,J.WEST];l.sort(()=>Math.sign(Math.random()*2-1));for(let d=0;d<4;d++){const f=l[d];if(!$o(n,a,f)||s===xn.LIGHT&&c>=3)continue;const h=G(a,kr[f]);i(h),++c}c===0&&!r&&(ne(n,a,xn.END),r=!0)};return i(t),{map:n,center:e}},Zo=n=>{const e=[],t=[];let r=null;const i=Array.from(Array(Xn).fill(null),()=>Array(Xn).fill(null));for(let a=0;a<n.length;a++)for(let o=0;o<n[a].length;o++){const s=y(o,a),c=Je(n,s);if(c===xn.EMPTY)continue;let l=0;for(let f=0;f<4;f++){const h=1<<f,_=Je(n,G(s,kr[h]));_!==xn.OUT_OF_BOUNDS&&_!==xn.EMPTY&&(l+=1<<f)}const d={position:s,cardinality:l,type:c};e.push(d),i[o][a]=d,c===xn.LIGHT&&t.push(d),c===xn.END&&(r=d)}return{tileSet:{allTiles:e,lightTiles:t,endTile:r},tileMap:i}},Ko=()=>{const{map:n,center:e}=Jo(),{tileSet:t,tileMap:r}=Zo(n);return{tileSet:t,tileMap:r,center:e}},Qo=n=>y(Math.round(n[0]/Wn+Xn/2),Math.round(n[2]/Wn+Xn/2)),Le=n=>b(Wn*(n[0]-Xn/2),0,Wn*(n[1]-Xn/2)),ns=n=>{let e=new Float32Array,t=new Float32Array,r=new Float32Array,i=[];for(const a of n){const o=ds(a);e=new Float32Array([...e,...o.vertices]),t=new Float32Array([...t,...o.normals]),r=new Float32Array([...r,...o.uvs]),i=[...i,...o.lights]}return{vertices:e,normals:t,uvs:r,lights:i}},es=(n,e)=>{const t=Qo(e),r=n[t[0]][t[1]];return r===null?(console.error("next does not exist"),null):r},ts=async({device:n,mainCanvas:{context:e,canvasFormat:t,depthData:{depthStencil:r,depthStencilTextureView:i},multisampleData:{msaaTextureView:a,multisample:o}}},s,{shadowMapTexture:c,lightSourcesBuffer:l,activeLightIndicesBuffer:d},{playerPerspectiveBuffer:f,playerPositionBuffer:h})=>{const{texture:_,sampler:p}=await Ye(n,"game/dungeon_textures_albedo.png"),{buffer:v,bufferLayout:g}=H(n,s.vertices,"float32x4"),{buffer:L,bufferLayout:I}=H(n,s.normals,"float32x4",1),{buffer:m,bufferLayout:w}=H(n,s.uvs,"float32x2",2),A=nn(n,[g,I,w],t,Ho,"triangle-list",{primitive:{frontFace:"ccw",cullMode:"front"},depthStencil:r,multisample:o},{blend:{color:{operation:"add",srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"zero"}}}),x=n.createBindGroup({layout:A.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:f}},{binding:1,resource:{buffer:h}}]}),P=Un(n,A,_,p,1),S=n.createBindGroup({layout:A.getBindGroupLayout(2),entries:[{binding:0,resource:{buffer:l}},{binding:1,resource:c.createView()},{binding:2,resource:{buffer:d}}]});return{pass:E=>{const V={view:a,resolveTarget:e.getCurrentTexture().createView(),loadOp:"clear",clearValue:pn.black,storeOp:"store"},R=E.beginRenderPass({colorAttachments:[V],depthStencilAttachment:{view:i,depthLoadOp:"clear",depthClearValue:1,depthStoreOp:"store"}});R.setPipeline(A),R.setVertexBuffer(0,v),R.setVertexBuffer(1,L),R.setVertexBuffer(2,m),R.setBindGroup(0,x),R.setBindGroup(1,P),R.setBindGroup(2,S),R.draw(s.vertices.length/4),R.end()}}},rs=`@group(0) @binding(0) var<uniform> projection_view : mat4x4f;\r
...
`,ue="mirrors",se={"Base color":0,Lambertian:1,Mirror:2,Refractive:3,Phong:4,Glossy:5},ei=ue+"-sphere-shader",ti=ue+"-triangle-shader",ri=ue+"-plane-shader",ii=ue+"-light-position-x-input",ai=ue+"-light-position-y-input",oi=ue+"-light-position-z-input",si=ue+"-animation-slider",Gs=async()=>{const{device:n,context:e,canvas:t,canvasFormat:r}=await cn(ue),i=k(ii),a=k(ai),o=k(oi),s=k(ei),c=k(ti),l=k(ri),d=k(si),f=t.width/t.height,h=nn(n,[],r,Cs,"triangle-strip"),_=new Float32Array([f,0]),{bindGroup:p,buffers:[v]}=z(n,h,[_],"UNIFORM"),g=new Float32Array([i(),a(),o(),se[s()],se[c()],se[l()],0,0,0]),{bindGroup:L,buffers:[I]}=z(n,h,[g],"UNIFORM",1),m=w=>{W(n,v,new Float32Array([f,w*d()/512]),0),W(n,I,new Float32Array([i(),a(),o(),se[s()],se[c()],se[l()],0,0,0]),0);const{pass:A,executePass:x}=un(n,e,pn.black);A.setPipeline(h),A.setBindGroup(0,p),A.setBindGroup(1,L),A.draw(4),x(),requestAnimationFrame(m)};requestAnimationFrame(m)},ks=(n,e)=>{const t=sn("Mirrors"),r=on("No description yet"),i=rn(),a=en(ue,{width:512+128,height:512-64}),o=_n(),s=O(Fn(ei,Object.keys(se),"Refractive"),"Sphere shader type",!1),c=O(Fn(ti,Object.keys(se),"Lambertian"),"Triangle shader type",!1),l=O(Fn(ri,Object.keys(se),"Lambertian"),"Plane shader type",!1),d=O(fn(ii,0,-5,5,.1),"Light X position"),f=O(fn(ai,1,0,5,.1),"Light Y position"),h=O(fn(oi,0,-5,5,.1),"Light Z position"),_=O(fn(si,0,0,1,.1),"Orbit animation speed");o.append(s,c,l,d,f,h,_),i.append(a,o),n.append(t,r,i),e.push(Gs)},ci=(n,e)=>{zs(n,e),ks(n,e)},Us=`@group(0) @binding(0) var texture_sampler : sampler;
...
`,ui="texturing",At="grass-texture-scale",De="subdivision-jitter-slider",St="grass-texture-select",di="texture-repeat-style-on-plane",qs=["clamp-to-edge","repeat","mirror-repeat"],$s=async()=>{const{device:n,canvas:e,context:t,canvasFormat:r}=await cn(ui),i=k(At),a=k(De),o=k(St),s=nn(n,[],r,Hs,"triangle-strip");let c,l;const d=async I=>{const m=[le("textures/grass.jpg"),le("textures/grass_minecraft.png")],w=await Promise.all(m),{texture:A,sampler:x}=Zn(n,w[0].textureData,w[0].width,w[0].height,{addressModeU:I,addressModeV:I}),{texture:P,sampler:S}=Zn(n,w[1].textureData,w[1].width,w[1].height,{addressModeU:I,addressModeV:I});c=Un(n,s,A,x),l=Un(n,s,P,S)};await d("repeat");const{bindGroup:f,buffers:[h]}=z(n,s,[new Float32Array([i(),a()*a()])],"UNIFORM",1),{bindGroup:_,buffers:[p]}=z(n,s,[new Float32Array(200)],"STORAGE",2),v=()=>{W(n,h,new Float32Array([i(),a()*a()]),0);const I={"grass.jpg":c,"grass_minecraft.png":l}[o()],{pass:m,executePass:w}=un(n,t,pn.black);m.setPipeline(s),m.setBindGroup(0,I),m.setBindGroup(1,f),m.setBindGroup(2,_),m.draw(4),w()},g=I=>{const m=ir(e.height,I);W(n,p,new Float32Array(B(m)),0,!0)},L=An(De,g);g(L),Et([At,St,De],v),An(di,async I=>{await d(I),v()}),v()},Ys=(n,e)=>{const t=sn("Applying textures in rendering"),r=on("No description yet"),i=rn(),a=en(ui),o=_n(),s=O(fn(At,.2,.1,2,.1),"Texture scale"),c=O(fn(De,1,1,10,1),"Subdivisions for stratisfied jitter"),l=O(Fn(St,["grass.jpg","grass_minecraft.png"],"grass_minecraft.png"),"Grass texture",!1),d=O(Fn(di,qs,"repeat"),"Texture edge behavior",!1);o.append(l,s,d,c),i.append(a,o),n.append(t,r,i),e.push($s)},hi=(n,e)=>{Ds(n,e),Ys(n,e)},Xs=`@group(0) @binding(0) var texture_sampler : sampler;
@group(0) @binding(1) var grass_texture : texture_2d<f32>;
