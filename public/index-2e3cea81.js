...
`,Ba=async()=>{const{device:n,canvas:e,context:t,canvasFormat:r}=await on("task1"),i=[].concat(T(ge([0,0],10*(2/e.height))),T(ge([1,0],10*(2/e.height))),T(ge([1,1],10*(2/e.height)))),a=new Float32Array(i),{buffer:o,bufferLayout:s}=$(n,a,"float32x2"),c=tn(n,[s],r,Ta),{pass:l,executePass:d}=dn(n,t,{r:.3921,g:.5843,b:.9294,a:1});l.setPipeline(c),l.setVertexBuffer(0,o),l.draw(i.length/2),d()},Pa=(n,e)=>{const t=an("Hello (GPU) world"),r=rn(`
...
Displaying anything on the screen is just a trivial extension of drawing some points, really.
        `),i=K("task1"),a=en();a.append(i),n.append(t,r,a),e.push(Ba)},Oa=`struct VSOut {
...
`,Fa=async()=>{const{device:n,context:e,canvasFormat:t}=await on("task2"),{pass:r,executePass:i}=dn(n,e,{r:.3921,g:.5843,b:.9294,a:1}),a=[w(0,0),w(1,0),w(1,1)],o=[b(1,0,0),b(0,1,0),b(0,0,1)],s=new Float32Array(T(a)),c=new Float32Array(T(o)),{buffer:l,bufferLayout:d}=$(n,s,"float32x2"),{buffer:f,bufferLayout:h}=$(n,c,"float32x3",1),v=tn(n,[d,h],t,Oa);r.setPipeline(v),r.setVertexBuffer(0,l),r.setVertexBuffer(1,f),r.draw(a.length),i()},Ea=(n,e)=>{const t=an("A formal introduction to the triangle"),r=rn(`
...
`),i=K("task2"),a=en();a.append(i),n.append(t,r,a),e.push(Fa)},Ma=`struct Time {
    time : f32
};
...
`,Va=async()=>{const{device:n,context:e,canvasFormat:t}=await on("task3"),r=ge(w(0,0),1),i=new Float32Array(T(r)),{bufferLayout:a,buffer:o}=$(n,i,"float32x2"),s=tn(n,[a],t,Ma),{bindGroup:c,buffers:[l]}=z(n,s,[new Float32Array(1)],"UNIFORM"),d=f=>{J(n,l,new Float32Array([f/1e3]),0);const{pass:h,executePass:v}=dn(n,e,{r:.3921,g:.5843,b:.9294,a:1});h.setPipeline(s),h.setVertexBuffer(0,o),h.setBindGroup(0,c),h.draw(r.length),v(),requestAnimationFrame(d)};requestAnimationFrame(d)},za=(n,e)=>{const t=an("Move, please"),r=rn(`
...
`),i=K("task3"),a=en();a.append(i),n.append(t,r,a),e.push(Va)},Ca=`struct Time {
    time : f32
};
...
`),i=en(),a=K("task4"),o=hn(),s=P(ln("ball-height",.3,.1,.9,.1),"Ball bounce height"),c=P(ln("ball-speed",4,1,16),"Ball bounce speed"),l=P(ln("ball-size",1.05,1.01,1.5,.01),"Ball size");o.append(s,c,l),i.append(a,o),n.append(t,r,i),e.push(Ga)},Ua=(n,e)=>{Pa(n,e),Ea(n,e),za(n,e),ka(n,e)},Na=`struct VSOut {
    @builtin(position) position : vec4f,
    @location(0) color : vec3f,
};
...
`),i=en(),a=K(ot),o=hn(),s=tt("display-draw-instruction"),c=Bn(st,ja),l=P(De(sr,"#000000"),"Draw color"),d=P(De(cr,"#ffffff"),"Background color"),f=P(ln(fr,10,2,100),"Point size"),h=P(ln(lr,12,4,32),"Circle granularity"),v=Pt(ur,"Clear canvas");o.append(s,c,l,f,h,d,v),i.append(a,o),n.append(t,r,i),e.push(Da)},qa=`struct Uniforms {
    mvp : mat4x4f,
};
...
`,dr="wireframe",hr="wireframe-rotation-slider",$a=async()=>{const{device:n,context:e,canvasFormat:t}=await on(dr),r=Ve(b(0),1),i=r.lineIndices,a=new Float32Array(T(r.vertices)),{buffer:o}=Cn(n,i),{buffer:s,bufferLayout:c}=$(n,a,"float32x4"),l=tn(n,[c],t,qa,"line-list"),{bindGroup:d,buffers:[f]}=z(n,l,[new Float32Array(nn(xn()))],"UNIFORM",0),h=yn(b(.5,.5,.5)),v=b(0,0,10),m=b(0),_=b(0,1,0),g=Fn(v,m,_),L=Ui(-1.5,1.5,-1.5,1.5,0,100),I=M(kt,L),p=M(I,g),y=x=>{const O=Pe(x,b(1,1,1)),S=M(O,h),F=M(p,S);J(n,f,new Float32Array(nn(F)),0);const{pass:E,executePass:V}=dn(n,e,vn.black);E.setPipeline(l),E.setVertexBuffer(0,s),E.setIndexBuffer(o,"uint32"),E.setBindGroup(0,d),E.drawIndexed(i.length),V()},A=wn(hr,y);y(A)},Xa=(n,e)=>{const t=an("Projecting a cube"),r=rn(`
...
`),i=en(),a=K(dr),o=hn(),s=P(ln(hr,45,0,360),"Rotation in degrees about (1, 1, 1)");o.append(s),i.append(a,o),n.append(t,r,i),e.push($a)},Ya=`struct Uniforms {
...
`,_r="perspective",Wa=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(_r),i=Ve(b(0),1),a=new Float32Array(T(i.vertices)),o=i.lineIndices,{buffer:s}=Cn(n,o),{buffer:c,bufferLayout:l}=$(n,a,"float32x4"),{buffer:d,bufferLayout:f}=$(n,new Float32Array(T([u(.5,.5,.5,1),u(0,0,1,1),u(0,1,0,1),u(0,1,1,1),u(1,0,1,1),u(1,0,0,1),u(1,1,0,1),u(1,1,1,1)])),"float32x4",1),h=tn(n,[l,f],t,Ya,"line-list"),v=b(0,0,5),m=b(0),_=b(0,1,0),g=Fn(v,m,_),L=Qn(45,r.width/r.height,.1,100),I=M(kt,L),p=M(I,g),y=M(Pe(0,b(1,1,1)),yn(b(-2))),A=M(Pe(45,b(0,1,0)),yn(b(0))),x=M(yn(b(2)),Pe(45,b(1,1,0))),O=M(p,y),S=M(p,A),F=M(p,x),{bindGroup:E}=z(n,h,[new Float32Array(be([O,S,F]))],"UNIFORM",0);(()=>{const{pass:B,executePass:R}=dn(n,e,vn.black);B.setPipeline(h),B.setVertexBuffer(0,c),B.setVertexBuffer(1,d),B.setIndexBuffer(s,"uint32"),B.setBindGroup(0,E),B.drawIndexed(o.length,3),R()})()},Ja=(n,e)=>{const t=an("Considering different perspectives"),r=rn(`
...
The base case is one-point perspective projection (left), where the two other principal directions are parallel to the image plane, but there exists also two- (middle) and three-point (right) projections with one and none parallel principal directions respectively.
    `),i=en(),a=K(_r,{width:1028-128}),o=hn();i.append(a,o),n.append(t,r,i),e.push(Wa)},Za=`struct Uniforms {
    time : f32,
    view : mat4x4f,
    projection : mat4x4f,
};
...
`,vr="airplane",mr="yaw-slider-airplane",pr="pitch-slider-airplane",gr="roll-slider-airplane",Ka=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(vr),i=k(mr),a=k(pr),o=k(gr),s=Ve(b(0),1),c=s.lineIndices,l=new Float32Array(T(s.vertices)),{buffer:d}=Cn(n,c),{buffer:f,bufferLayout:h}=$(n,l,"float32x4"),v=tn(n,[h],t,Za,"line-list"),m=b(5,5,5),_=b(0),g=b(0,1,0),L=Fn(m,_,g),I=Qn(35,r.width/r.height,.1,100),p=M(kt,I),{bindGroup:y,buffers:[A]}=z(n,v,[new Float32Array([0,0,0,0,...nn(L),...nn(p)])],"UNIFORM",0),x=[],O=Gn(.4,.4,2),S=M(Gn(.35,.25,.35),yn(b(0,-.2,3.3))),F=M(Gn(1.7,.2,1.1),yn(b(.6))),E=M(Gn(1.7,.2,1.1),yn(b(-.6))),V=M(Gn(.2,.5,.3),yn(b(0,.5,-3.3))),B=M(Gn(.5,.1,.2),yn(b(-.9,.4,-4.3))),R=M(Gn(.5,.1,.2),yn(b(.9,.4,-4.3))),H=[O,S,F,E,V,B,R];x.push(...new Array(H.length).fill(u(.7,.7,.7)));const sn=(gn=xn())=>M(M(Gn(.1,.3,.2),gn),yn(b(0,.5,-6)));x.push(u(0,1,0));const cn=(gn=xn())=>M(M(Gn(.25,.05,.2),gn),yn(b(2,.4,-5.3))),U=(gn=xn())=>M(M(Gn(.25,.05,.2),gn),yn(b(-2,.4,-5.3)));x.push(u(1,0,0),u(1,0,0));const X=(gn=xn())=>M(M(yn(b(-1,.1,-.5)),gn),Gn(1,.1,.3)),W=(gn=xn())=>M(M(yn(b(1,.1,-.5)),gn),Gn(1,.1,.3));x.push(u(.4,.4,1),u(.4,.4,1));const C=[...H,sn(),cn(),U(),X(),W()],{bindGroup:q,buffers:Q}=z(n,v,[new Float32Array(be(C)),new Float32Array(T(x))],"STORAGE",1);let pn=0,bn=0,Z=0,fn=0,_n=0,j=0;const D=.1,En=gn=>{J(n,A,new Float32Array([gn]),0);const Xn=1*i();fn=fn*(1-D)+Xn*D,pn+=fn;const Pn=1*a();_n=_n*(1-D)+Pn*D,bn+=_n;const ue=1*o();j=j*(1-D)+ue*D,Z+=j;const On=Ee(-fn*20),te=Te(-_n*20),de=j>0?Te(j*60):xn(),me=j<0?Te(-j*60):xn(),Nn=M(M(Te(bn),Ee(pn)),Ni(Z)),N=[...H.map(Yn=>M(Nn,Yn)),M(Nn,sn(On)),M(Nn,cn(te)),M(Nn,U(te)),M(Nn,X(de)),M(Nn,W(me))],un=N.map(Yn=>M(Nn,Yn));J(n,Q[0],new Float32Array(be(un)),0);const{pass:In,executePass:he}=dn(n,e,vn.black);In.setPipeline(v),In.setVertexBuffer(0,f),In.setIndexBuffer(d,"uint32"),In.setBindGroup(0,y),In.setBindGroup(1,q),In.drawIndexed(c.length,N.length),he(),requestAnimationFrame(En)};requestAnimationFrame(En)},Qa=(n,e)=>{const t=an("About Gimbal's lock"),r=rn(`
...
One may think of these are homogeneous Euler angles.
    `),i=en(),a=K(vr),o=hn(),s=P(ln(mr,0,-1,1,.1),"Green rudder control (yaw)"),c=P(ln(pr,0,-1,1,.1),"Red elevators control (pitch)"),l=P(ln(gr,0,-.5,.5,.1),"Blue ailerons control (roll)");o.append(s,c,l),i.append(a,o),n.append(t,r,i),e.push(Ka)},no=(n,e)=>{Xa(n,e),Ja(n,e),Qa(n,e)},eo=`struct SceneData {
    pvm : mat4x4f,
    observer : vec4f,
...
`,xr="graphics-lighting",Ne="rotation-around-tetrahedron",ct="subdivision-tetrahedron",br="tetrahedron-rotation-animation-enabled",lt="diffuse-reflectance-tetrahedron",ft="specular-reflectance-tetrahedron",ut="ambient-reflectance-tetrahedron",dt="shading-type-tetrahedron",ht="shininess-tetrahedron",_t="tetrahedron-light-emission",to=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(xr),i=k(Ne),a=k(ct),o=k(dt),s=k(ut),c=k(lt),l=k(ft),d=k(ht),f=k(_t),h=new Array(8).fill(0).map((fn,_n)=>zt(_n)),{buffer:v}=Cn(n,new Uint32Array(T(h[7].triangleIndices.map(fn=>Ln(fn))))),{buffer:m,bufferLayout:_}=$(n,new Float32Array(T(h[7].vertices)),"float32x4"),{buffer:g,bufferLayout:L}=$(n,new Float32Array(T([u(1,0,0),u(0,1,0),u(0,0,1),u(1,1,1),...new Array(h[7].vertices.length-4).fill(u(.4,.4,.4))])),"float32x4",1);Vn(n,v,new Uint32Array(T(h[a()].triangleIndices.map(fn=>Ln(fn)))),0,!0);const I=4,{multisample:p,msaaTexture:y}=Ie(n,r,t,I),{createDepthTexture:A,depthStencil:x,depthStencilAttachmentFactory:O}=fe(n,r,I),S=tn(n,[_,L],t,eo,"triangle-list",{multisample:p,depthStencil:x});A();const F=zn(i()),E=b(3*Math.sin(F),0,3*Math.cos(F)),V=b(0),B=b(0,1,0),R=Fn(E,V,B),sn=Qn(45,r.width/r.height,.1,100),U=M(sn,R),X={"Gouraud shading (vertex)":0,"Phong shading (fragment)":1},{bindGroup:W,buffers:[C]}=z(n,S,[new Float32Array([...nn(U),...u(...E),...qe(ce(f())),...u(s(),c(),l(),d()),...u(X[o()])])],"UNIFORM",0),q=fn=>{const _n=zn(fn),j=b(3*Math.sin(_n),0,3*Math.cos(_n)),D=Fn(j,V,B),gn=M(sn,D);J(n,C,new Float32Array([...nn(gn),...u(...j)]),0)};wn(ct,fn=>{Vn(n,v,new Uint32Array(T(h[fn].triangleIndices.map(_n=>Ln(_n)))),0,!0)}),wn(Ne,q);let pn=!0;wn(br,()=>pn=document.getElementById(Ne).disabled=!pn),Ft([dt,ht,ft,lt,ut,_t],()=>{J(n,C,new Float32Array([...qe(ce(f())),...u(s(),c(),l(),d()),...u(X[o()])]),80)});const Z=fn=>{pn&&q(fn/50);const{pass:_n,executePass:j}=dn(n,e,u(.2,.2,.2),{depthStencilAttachmentFactory:O,msaaTexture:y});_n.setPipeline(S),_n.setVertexBuffer(0,m),_n.setVertexBuffer(1,g),_n.setIndexBuffer(v,"uint32"),_n.setBindGroup(0,W),_n.drawIndexed(h[a()].triangleCount*3),j(),requestAnimationFrame(Z)};requestAnimationFrame(Z)},ro=(n,e)=>{const t=an("Shining light on tetrahedrons"),r=rn(`
...
`,Lr="checkerboard-test",vt="texture-repeat-style",co=["clamp-to-edge","repeat","mirror-repeat"],mt="magnification-checkerboard",pt="minification-checkerboard",et=["linear","nearest"],lo=async()=>{const{device:n,context:e,canvasFormat:t}=await on(Lr),r=k(vt),i=k(pt),a=k(mt),o=k(gt),s=new Float32Array(T([u(-4,-1,-1),u(4,-1,-1),u(4,-1,-21),u(-4,-1,-21)])),c=new Uint32Array([0,1,2,0,2,3]),l=new Float32Array(T([w(-1.5,0),w(2.5,0),w(2.5,10),w(-1.5,10)])),{buffer:d}=Cn(n,c),{buffer:f,bufferLayout:h}=$(n,s,"float32x4"),{buffer:v,bufferLayout:m}=$(n,l,"float32x2",1),_=tn(n,[h,m],t,so,"triangle-list"),g=$i(64,8,8),L=Ct(g,64,!0),I=async()=>{const{texture:p,sampler:y}=Kn(n,g,64,64,{addressModeU:r(),addressModeV:r(),minFilter:i(),magFilter:a(),mipmapFilter:o()},{mips:L}),A=Un(n,_,p,y),{pass:x,executePass:O}=dn(n,e,vn.blueScreenBlue);x.setPipeline(_),x.setVertexBuffer(0,f),x.setVertexBuffer(1,v),x.setIndexBuffer(d,"uint32"),x.setBindGroup(0,A),x.drawIndexed(6),O()};Ft([vt,mt,pt,gt],I),I()},gt="mipmap-select-checkerboard",fo=(n,e)=>{const t=an("Applying textures"),r=rn("No description yet"),i=en(),a=K(Lr),o=hn(),s=P(Bn(vt,co,"repeat"),"Texture edge behaviour",!1),c=P(Bn(pt,et,"nearest"),"Minification behaviour",!1),l=P(Bn(mt,et,"nearest"),"Magnification behaviour",!1),d=P(Bn(gt,et,"nearest"),"Mipmap behaviour",!1);o.append(s,c,l,d),i.append(a,o),n.append(t,r,i),e.push(lo)},uo=`struct SceneData {
    pvm : mat4x4f,
};
...
`,Ir="earth",ho=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(Ir),{textureData:i,width:a,height:o}=await le("textures/earth.jpg"),s=zt(7),{buffer:c}=Cn(n,new Uint32Array(T(s.triangleIndices.map(W=>Ln(W))))),{buffer:l,bufferLayout:d}=$(n,new Float32Array(T(s.vertices)),"float32x4"),{buffer:f,bufferLayout:h}=$(n,new Float32Array(T([u(1,0,0),u(0,1,0),u(0,0,1),u(1,1,1),...new Array(s.vertices.length-4).fill(u(.4,.4,.4))])),"float32x4",1),v=4,{multisample:m,msaaTexture:_}=Ie(n,r,t,v),{depthStencil:g,depthStencilAttachmentFactory:L}=fe(n,r,v),I=tn(n,[d,h],t,uo,"triangle-list",{multisample:m,depthStencil:g}),{sampler:p,texture:y}=Kn(n,i,a,o,{minFilter:"nearest",magFilter:"nearest"}),A=Un(n,I,y,p,1),x=zn(0),O=b(3*Math.sin(x),0,3*Math.cos(x)),S=b(0),F=b(0,1,0),E=Fn(O,S,F),B=Qn(45,r.width/r.height,.1,100),H=M(B,E),{bindGroup:sn,buffers:[cn]}=z(n,I,[new Float32Array(nn(H))],"UNIFORM",0),U=W=>{const C=zn(W),q=b(3*Math.sin(C),Math.cos(C),3*Math.cos(C)),Q=Fn(q,S,F),bn=M(B,Q);J(n,cn,new Float32Array(nn(bn)),0)},X=W=>{U(W/50);const{pass:C,executePass:q}=dn(n,e,u(.5,.1,.5),{depthStencilAttachmentFactory:L,msaaTexture:_});C.setPipeline(I),C.setVertexBuffer(0,l),C.setVertexBuffer(1,f),C.setIndexBuffer(c,"uint32"),C.setBindGroup(0,sn),C.setBindGroup(1,A),C.drawIndexed(s.triangleCount*3),q(),requestAnimationFrame(X)};requestAnimationFrame(X)},_o=(n,e)=>{const t=an("A sphere"),r=rn("no desc yet"),i=en(),a=K(Ir),o=hn();o.append(),i.append(a,o),n.append(t,r,i),e.push(ho)},vo=(n,e)=>{fo(n,e),_o(n,e)},mo=`@group(0) @binding(0) var cube_sampler : sampler;
...
`,Ar="texture-sphere-with-quad",Sr="env-sphere-reflect-type",Rr={"Faux reflection":0,"Mirror reflection":1,"Show normal map":2,"Bump reflection":3},po=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(Ar),[i,...a]=await Promise.all(["textures/normalmap.png","textures/cubemap/cm_left.png","textures/cubemap/cm_right.png","textures/cubemap/cm_top.png","textures/cubemap/cm_bottom.png","textures/cubemap/cm_back.png","textures/cubemap/cm_front.png"].map(Pn=>le(Pn))),o=b(0,0,3),s=b(0),c=b(0,1,0),l=Fn(o,s,c),f=Qn(90,r.width/r.height,.1,100),h=M(f,l),v=Dt(f),m=Dt(l),_=Hi(m,[0,0],[3,3]),g=kn(),L=qi(_,g),I=M(L,v),p=zt(7),y=T(p.triangleIndices.map(Pn=>Ln(Pn))),A=T(p.vertices.map(Pn=>Oe(Pn,h))),x=.999,O=T([u(-1,-1,x,1),u(1,-1,x,1),u(-1,1,x,1),u(1,1,x,1)]),S=[p.vertices.length+0,p.vertices.length+1,p.vertices.length+2,p.vertices.length+1,p.vertices.length+3,p.vertices.length+2],{buffer:F}=Cn(n,new Uint32Array([...y,...S])),{buffer:E,bufferLayout:V}=$(n,new Float32Array([...A,...O]),"float32x4"),{buffer:B,bufferLayout:R}=$(n,new Float32Array([...T(p.vertices),...O]),"float32x4",1),{buffer:H,bufferLayout:sn}=$(n,new Float32Array([...Array(p.vertices.length).fill(0),...Array(4).fill(1)]),"uint32",2),cn=4,{multisample:U,msaaTexture:X}=Ie(n,r,t,cn),{depthStencil:W,depthStencilAttachmentFactory:C}=fe(n,r,cn),q=tn(n,[V,R,sn],t,mo,"triangle-list",{multisample:U,depthStencil:W}),{sampler:Q,cubemapTexture:pn}=Ra(n,a.map(Pn=>Pn.textureData),a[0].width,a[0].height),bn=Un(n,q,pn,Q,0,{createViewOverwrite:{dimension:"cube"}}),{bindGroup:Z,buffers:[fn,_n,j]}=z(n,q,[new Float32Array(be([xn(),I])),new Float32Array([...o]),new Uint32Array([0])],"UNIFORM",1),{texture:D,sampler:En}=Kn(n,i.textureData,i.width,i.height),gn=Un(n,q,D,En,2),Xn=Pn=>{const ue=Rr[Pn];Vn(n,j,new Uint32Array([ue]),0);const{pass:On,executePass:te}=dn(n,e,u(.5,.1,.5),{depthStencilAttachmentFactory:C,msaaTexture:X});On.setPipeline(q),On.setVertexBuffer(0,E),On.setVertexBuffer(1,B),On.setVertexBuffer(2,H),On.setIndexBuffer(F,"uint32"),On.setBindGroup(0,bn),On.setBindGroup(1,Z),On.setBindGroup(2,gn),On.drawIndexed(p.triangleCount*3+S.length),te()};Xn(wn(Sr,Xn))},go=(n,e)=>{const t=an("A sphere"),r=rn("explain transformation"),i=en(),a=K(Ar),o=hn(),s=P(Bn(Sr,Object.keys(Rr),"Faux reflection"),"Reflection type",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(po)},xo=(n,e)=>{go(n,e)},Wt=`@group(0) @binding(0) var marble_sampler : sampler;
...
`,Io=`@group(0) @binding(0) var<uniform> teapot_model : mat4x4f;
...
`,Ao=`@group(0) @binding(0) var<uniform> model : mat4x4f;
...
`,Ye="shadow-mapping",Br="teapot-movement-shadow-mapping",Pr="light-movement-shadow-mapping",So=async()=>{const n=k(Br,"checked"),e=k(Pr,"checked"),t=await le("textures/xamp23.png"),r=await $n("models/teapot.obj",.25,!1),i=ee(r,{indicesIn3:!0}),{device:a,context:o,canvasFormat:s,canvas:c}=await on(Ye),l=document.getElementById(Ye+"-shadow"),d=l.getContext("gpupresent")||l.getContext("webgpu");d.configure({device:a,format:s});const{depthStencil:f,depthStencilAttachmentFactory:h}=fe(a,c,1),{buffer:v}=Cn(a,i.indices),{buffer:m,bufferLayout:_}=$(a,i.vertices,"float32x4"),{buffer:g,bufferLayout:L}=$(a,i.normals,"float32x4",1),{buffer:I,bufferLayout:p}=$(a,i.colors,"float32x4",2),y=tn(a,[_,L,p],s,Io,"triangle-list",{depthStencil:f}),A=a.createTexture({size:{width:l.width,height:l.height,depthOrArrayLayers:1},mipLevelCount:1,sampleCount:1,dimension:"2d",format:"rgba32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),x=A.createView(),O=a.createShaderModule({code:Ao}),S=a.createRenderPipeline({layout:"auto",vertex:{module:O,entryPoint:"main_vs",buffers:[_]},fragment:{module:O,entryPoint:"main_fs",targets:[{format:s},{format:"rgba32float"}]},primitive:{cullMode:"none",topology:"triangle-list"}}),{bindGroup:F,buffers:[E,V]}=z(a,S,[new Float32Array(nn(xn())),new Float32Array(nn(kn()))],"UNIFORM",0),B=new Uint32Array([0,1,2,0,2,3]),R=new Float32Array(T([w(0,0),w(1,0),w(1,1),w(0,1)])),H=new Float32Array(T([u(-2,-1,-1),u(2,-1,-1),u(2,-1,-5),u(-2,-1,-5)])),{buffer:sn}=Cn(a,new Uint32Array([...B])),{buffer:cn,bufferLayout:U}=$(a,new Float32Array([...H]),"float32x4"),{buffer:X,bufferLayout:W}=$(a,new Float32Array([...R]),"float32x2",1),C=tn(a,[U,W],s,Lo,"triangle-list",{depthStencil:f}),q=a.createBindGroup({layout:C.getBindGroupLayout(2),entries:[{binding:0,resource:A.createView()}]}),Q=new Float32Array(nn(Qn(90,1,.001,6))),pn=N=>{const un=Qn(100,1,.01,4),In=Fn(N,b(0,-1,-3),Qt.up);return M(un,In)},bn=N=>{const un=new Float32Array(nn(pn(N)));J(a,V,un,0),J(a,_n,un,0)},{bindGroup:Z,buffers:[fn,_n,j]}=z(a,C,[Q,new Float32Array(nn(kn())),new Float32Array(nn(kn()))],"UNIFORM",1),D=Ct(t.textureData,t.width),{texture:En,sampler:gn}=Kn(a,t.textureData,t.width,t.height,{addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",minFilter:"nearest",magFilter:"nearest",mipmapFilter:"nearest"},{mips:D}),Xn=Un(a,C,En,gn),{bindGroup:Pn,buffers:[ue,On]}=z(a,y,[new Float32Array(nn(kn())),new Float32Array(b()),Q],"UNIFORM",0);let te=0,de=0,me=0;const Nn=N=>{const un=(N-me)/1e3;te+=n()?un:0,de+=e()?un:0;const In=b(2*Math.cos(de),2,2*Math.sin(de)-2);J(a,On,new Float32Array(In),0),bn(In);const he=yn(b(0,(Math.cos(te)*3-1)/4,-3)),Yn=new Float32Array(nn(he));J(a,ue,Yn,0),J(a,E,Yn,0),J(a,j,Yn,0);const Ae=a.createCommandEncoder(),se=Ae.beginRenderPass({colorAttachments:[{view:d.getCurrentTexture().createView(),loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"},{view:x,loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"}]});se.setPipeline(S),se.setVertexBuffer(0,m),se.setIndexBuffer(v,"uint32"),se.setBindGroup(0,F),se.drawIndexed(i.indices.length),se.end();const Tn=Ae.beginRenderPass({colorAttachments:[{view:o.getCurrentTexture().createView(),loadOp:"clear",clearValue:vn.blueScreenBlue,storeOp:"store"}],depthStencilAttachment:h()});Tn.setPipeline(C),Tn.setVertexBuffer(0,cn),Tn.setVertexBuffer(1,X),Tn.setIndexBuffer(sn,"uint32"),Tn.setBindGroup(0,Xn),Tn.setBindGroup(1,Z),Tn.setBindGroup(2,q),Tn.drawIndexed(6),Tn.setPipeline(y),Tn.setVertexBuffer(0,m),Tn.setVertexBuffer(1,g),Tn.setVertexBuffer(2,I),Tn.setIndexBuffer(v,"uint32"),Tn.setBindGroup(0,Pn),Tn.drawIndexed(i.indices.length),Tn.end(),a.queue.submit([Ae.finish()]),me=N,requestAnimationFrame(Nn)};requestAnimationFrame(Nn)},Ro=(n,e)=>{const t=an("shadow mapping"),r=rn("https://toolness.github.io/shadowmap-2d/"),i=en(),a=K(Ye),o=hn(),s=P(ne(Br,!0),"Teapot movement",!1),c=P(ne(Pr,!0),"Light movement",!1);o.append(s,c),i.append(a,o);const l=en(),d=K(Ye+"-shadow");l.append(d),n.append(t,r,i,l),e.push(So)},To=(n,e)=>{Ro(n,e)},Bo=`struct SceneData {
    pvm : mat4x4f,
    observer : vec4f,
};
...
`,Vo={[Y.NORTH]:Y.SOUTH,[Y.EAST]:Y.WEST,[Y.SOUTH]:Y.NORTH,[Y.WEST]:Y.EAST},Er=n=>{const e=[];n&Y.NORTH&&e.push(Y.NORTH),n&Y.EAST&&e.push(Y.EAST),n&Y.SOUTH&&e.push(Y.SOUTH),n&Y.WEST&&e.push(Y.WEST);const t=Math.round(Math.random()*e.length-.5);return e[t]},Mr={1:w(0,1),2:w(1,0),4:w(0,-1),8:w(-1,0)},yt={[Y.NORTH]:u(0,0,1,0),[Y.EAST]:u(1,0,0,0),[Y.SOUTH]:u(0,0,-1,0),[Y.WEST]:u(-1,0,0,0)},Hn=12,Wn=(n,e,t)=>{n[e[0]][e[1]]=t},We=(n,e)=>e[1]>=0&&e[1]<Hn&&e[0]>=0&&e[0]<Hn?n[e[0]][e[1]]:mn.OUT_OF_BOUNDS,ke=(n,e)=>We(n,e)===mn.EMPTY,Dn=(n,e)=>{const t=We(n,e);return t===mn.EMPTY||t===mn.OUT_OF_BOUNDS},zo=(n,e,t)=>{switch(t){case Y.NORTH:return Dn(n,G(e,w(-1,1)))&&ke(n,G(e,w(0,1)))&&Dn(n,G(e,w(1,1)));case Y.EAST:return Dn(n,G(e,w(1,1)))&&ke(n,G(e,w(1,0)))&&Dn(n,G(e,w(1,-1)));case Y.SOUTH:return Dn(n,G(e,w(-1,-1)))&&ke(n,G(e,w(0,-1)))&&Dn(n,G(e,w(1,-1)));case Y.WEST:return Dn(n,G(e,w(-1,1)))&&ke(n,G(e,w(-1,0)))&&Dn(n,G(e,w(-1,-1)))}return!1},Co=(n,e)=>{const t=!Dn(n,G(e,w(0,1)))&&!Dn(n,G(e,w(0,-1))),r=!Dn(n,G(e,w(1,0)))&&!Dn(n,G(e,w(-1,0)));return t||r},Go=()=>Math.random()<.15?mn.LIGHT:mn.NORMAL,ko=(n,e)=>(Wn(n,G(e,w(1,0)),mn.NORMAL),Wn(n,G(e,w(0,0)),mn.SPAWN),Wn(n,G(e,w(-1,0)),mn.NORMAL),Wn(n,G(e,w(1,1)),mn.LIGHT),Wn(n,G(e,w(0,1)),mn.NORMAL),Wn(n,G(e,w(-1,1)),mn.LIGHT),Wn(n,G(e,w(1,2)),mn.NORMAL),Wn(n,G(e,w(0,2)),mn.NORMAL),Wn(n,G(e,w(-1,2)),mn.NORMAL),G(e,w(0,3))),Uo=()=>{const n=Array.from(Array(Hn).fill(null),()=>Array(Hn).fill(mn.EMPTY)),e=w(Hn/2,Hn/2),t=ko(n,e);let r=!1;const i=a=>{const o=Co(n,a),s=Go();if(s===mn.EMPTY||o)return;Wn(n,a,s);let c=0;const l=[Y.NORTH,Y.EAST,Y.SOUTH,Y.WEST];l.sort(()=>Math.sign(Math.random()*2-1));for(let d=0;d<4;d++){const f=l[d];if(!zo(n,a,f)||s===mn.LIGHT&&c>=3)continue;const h=G(a,Mr[f]);i(h),++c}c===0&&!r&&(Wn(n,a,mn.END),r=!0)};return i(t),{map:n,center:e}},No=n=>{const e=[],t=[];let r=null;const i=Array.from(Array(Hn).fill(null),()=>Array(Hn).fill(null));for(let a=0;a<n.length;a++)for(let o=0;o<n[a].length;o++){const s=w(o,a),c=We(n,s);if(c===mn.EMPTY)continue;let l=0;for(let f=0;f<4;f++){const h=1<<f,v=We(n,G(s,Mr[h]));v!==mn.OUT_OF_BOUNDS&&v!==mn.EMPTY&&(l+=1<<f)}const d={position:s,cardinality:l,type:c};e.push(d),i[o][a]=d,c===mn.LIGHT&&t.push(d),c===mn.END&&(r=d)}return{tileSet:{allTiles:e,lightTiles:t,endTile:r},tileMap:i}},jo=()=>{const{map:n,center:e}=Uo(),{tileSet:t,tileMap:r}=No(n);return{tileSet:t,tileMap:r,center:e}},Do=n=>w(Math.round(n[0]/qn+Hn/2),Math.round(n[2]/qn+Hn/2)),ye=n=>b(qn*(n[0]-Hn/2),0,qn*(n[1]-Hn/2)),Ho=n=>{let e=new Float32Array,t=new Float32Array,r=new Float32Array,i=[];for(const a of n){const o=ts(a);e=new Float32Array([...e,...o.vertices]),t=new Float32Array([...t,...o.normals]),r=new Float32Array([...r,...o.uvs]),i=[...i,...o.lights]}return{vertices:e,normals:t,uvs:r,lights:i}},qo=(n,e)=>{const t=Do(e),r=n[t[0]][t[1]];return r===null?(console.error("next does not exist"),null):r},$o=async({device:n,mainCanvas:{context:e,canvasFormat:t,depthData:{depthStencil:r,depthStencilTextureView:i},multisampleData:{msaaTextureView:a,multisample:o}}},s,{shadowMapTexture:c,lightSourcesBuffer:l,activeLightIndicesBuffer:d},{playerPerspectiveBuffer:f,playerPositionBuffer:h})=>{const{texture:v,sampler:m}=await $e(n,"game/dungeon_textures_albedo.png"),{buffer:_,bufferLayout:g}=$(n,s.vertices,"float32x4"),{buffer:L,bufferLayout:I}=$(n,s.normals,"float32x4",1),{buffer:p,bufferLayout:y}=$(n,s.uvs,"float32x2",2),A=tn(n,[g,I,y],t,Mo,"triangle-list",{primitive:{frontFace:"ccw",cullMode:"front"},depthStencil:r,multisample:o},{blend:{color:{operation:"add",srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"zero"}}}),x=n.createBindGroup({layout:A.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:f}},{binding:1,resource:{buffer:h}}]}),O=Un(n,A,v,m,1),S=n.createBindGroup({layout:A.getBindGroupLayout(2),entries:[{binding:0,resource:{buffer:l}},{binding:1,resource:c.createView()},{binding:2,resource:{buffer:d}}]});return{pass:E=>{const V={view:a,resolveTarget:e.getCurrentTexture().createView(),loadOp:"clear",clearValue:vn.black,storeOp:"store"},B=E.beginRenderPass({colorAttachments:[V],depthStencilAttachment:{view:i,depthLoadOp:"clear",depthClearValue:1,depthStoreOp:"store"}});B.setPipeline(A),B.setVertexBuffer(0,_),B.setVertexBuffer(1,L),B.setVertexBuffer(2,p),B.setBindGroup(0,x),B.setBindGroup(1,O),B.setBindGroup(2,S),B.draw(s.vertices.length/4),B.end()}}},Xo=`@group(0) @binding(0) var<uniform> projection_view : mat4x4f;\r
...
`,Yo=`@group(0) @binding(0) var<uniform> projection_view : mat4x4f;
...
`,Zt=4,wt=30,Vr=n=>{const e=Fn(Ln(n.position),Ln(G(n.position,n.direction)),b(0,1,0)),t=Qn(170,5,.01,qn*2);return M(t,e)},Wo=n=>{n.active=!1,n.intensity=0},Jo=n=>{n.active=!0},Zo=n=>new Float32Array(n.flatMap(e=>[T([e.position,e.direction]),nn(Vr(e)),[...e.tint,e.intensity]].flat())),Ko=({device:n},e,t)=>{let r=t.reduce((A,x)=>A.vertexCount>x.vertexCount?A:x,t[0]);const i=n.createShaderModule({code:Yo}),a=n.createRenderPipeline({layout:"auto",vertex:{module:i,entryPoint:"main_vs",buffers:[r.vertexBufferLayout]},fragment:{module:i,entryPoint:"main_fs",targets:[{format:"rgba32float"}]},primitive:{frontFace:"ccw",cullMode:"none",topology:"triangle-list"},depthStencil:{depthWriteEnabled:!0,depthCompare:"less",format:"depth24plus"}}),o=n.createTexture({size:{width:2048,height:512,depthOrArrayLayers:e.length},format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT}),s=n.createTexture({size:{width:2048,height:512,depthOrArrayLayers:e.length},dimension:"2d",format:"rgba32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),c=e.map(A=>z(n,a,[new Float32Array(nn(Vr(A)))],"UNIFORM",0).bindGroup),l=t.map(A=>{const x=Jt(A)?new Float32Array(be(A.modelMatrices)):new Float32Array(nn(xn()));return z(n,a,[x],"STORAGE",1).bindGroup}),{bindGroup:d}=z(n,a,[new Float32Array(nn(xn()))],"UNIFORM",2),{bindGroup:f,buffers:[h]}=z(n,a,[new Float32Array(nn(xn()))],"UNIFORM",2),v=(A,x)=>{if(x%2===0)return;const O=A/1e3,S=yn([.01*Math.sin(O)*Math.random(),.01*Math.sin(O)*Math.random(),.01*Math.sin(O)*Math.random()]);J(n,h,new Float32Array(nn(S)),0)},m=(A,x,O)=>{y(x),v(x,O);for(let S=0;S<e.length;S++){if(!g.includes(S))continue;const F=A.beginRenderPass({colorAttachments:[{view:s.createView({baseArrayLayer:S,arrayLayerCount:1}),loadOp:"clear",clearValue:vn.black,storeOp:"store"}],depthStencilAttachment:{view:o.createView({baseArrayLayer:S,arrayLayerCount:1}),depthLoadOp:"clear",depthStoreOp:"store",depthClearValue:1}});F.setPipeline(a),F.setBindGroup(0,c[S]);for(let E=0;E<t.length;E++){const V=t[E];if(F.setVertexBuffer(0,V.vertexBuffer),F.setBindGroup(1,l[E]),!V.indexBuffer||!V.triangleCount){F.setBindGroup(2,d),F.draw(V.vertexCount);continue}F.setBindGroup(2,f);const B=Jt(V)?V.instances:void 0;F.setIndexBuffer(V.indexBuffer,"uint32"),F.drawIndexed(V.triangleCount*3,B)}F.end()}},_=[];let g=[];const L=n.createBuffer({size:new Uint32Array(Zt).byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.length>wt&&console.warn("[initialization] number of lights larger than allowed limit");const I=n.createBuffer({size:(Rn.float32x4*2+Rn.float32x4x4+Rn.float32x4)*wt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});n.queue.writeBuffer(I,0,Zo(e));const p=A=>{g=Ia(e.map(x=>nr(_e(x.position,u(...A,1)))),Zt),n.queue.writeBuffer(L,0,new Uint32Array(g));for(const x of g)Jo(e[x]);for(let x=0;x<e.length;x++)if(!g.includes(x)){Wo(e[x]);const O=Rn.float32x4*2+Rn.float32x4x4+Rn.float32x4;J(n,I,new Float32Array([0]),O*x+O-Rn.float32)}for(const x of _)x(g)},y=A=>{const x=S=>S<6?S+=.1*Math.random():Math.sin(A/1e4)*Math.random()+6,O=Rn.float32x4*2+Rn.float32x4x4+Rn.float32x4;for(const S of g){const F=e[S];F.intensity=x(F.intensity),J(n,I,new Float32Array([F.intensity]),O*S+O-Rn.float32)}};return{renderable:{pass:m,onTileChange:p},lightData:{lights:e,shadowMapTexture:s,activeLightsChangeListeners:_,lightSourcesBuffer:I,activeLightIndicesBuffer:L}}},Qo=n=>{const e=qn/2-.1,t=Er(~n.cardinality&15),r=yt[t],i=ye(n.position),a=G(u(...G(b(0,.4,0),i),1),Jn(r,e));return{direction:yt[Vo[t]],position:a,intensity:0,tint:b(.9,.4,0),active:!1}},ns=({device:n},e)=>{const t=Ve(b(),1),r=[w(0,0),w(0,1),w(0,1),w(0,0),w(0,0),w(0,1),w(0,1),w(0,0)],i=e.map(h=>{const v=yn(Ln(G(h.position,G(Jn(h.direction,.1),u(0,-.65,0,0))))),m=M(Ee(90),Pe(30,Ln(h.direction))),_=Gn(.1,.65,.1);return M(M(v,m),_)}),{buffer:a}=Cn(n,new Uint32Array(T(t.triangleIndices.map(h=>Ln(h))))),{buffer:o,bufferLayout:s}=$(n,new Float32Array(T(t.vertices)),"float32x4"),{buffer:c,bufferLayout:l}=$(n,new Float32Array(T(t.normals)),"float32x4",1),{buffer:d,bufferLayout:f}=$(n,new Float32Array(T(r)),"float32x2",2);return{vertexBuffer:o,vertexBufferLayout:s,vertexCount:t.vertices.length,normalsBuffer:c,normalsBufferLayout:l,uvsBuffer:d,uvsBufferLayout:f,indexBuffer:a,triangleCount:t.triangleCount,instances:e.length,modelMatrices:i}},es=({device:n,mainCanvas:{context:e,canvasFormat:t,depthData:{depthStencil:r,depthStencilTextureView:i},multisampleData:{msaaTextureView:a,multisample:o}}},{vertexBuffer:s,vertexBufferLayout:c,normalsBuffer:l,normalsBufferLayout:d,uvsBuffer:f,uvsBufferLayout:h,indexBuffer:v,triangleCount:m,instances:_,modelMatrices:g},{playerPerspectiveBuffer:L},{lightSourcesBuffer:I})=>{const p=tn(n,[c,d,h],t,Xo,"triangle-list",{primitive:{frontFace:"ccw",cullMode:"back"},depthStencil:r,multisample:o}),y=new Float32Array(be(g)),A=n.createBuffer({size:Rn.float32x4x4*wt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});n.queue.writeBuffer(A,0,y);const x=n.createBindGroup({layout:p.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:L}},{binding:1,resource:{buffer:A}},{binding:2,resource:{buffer:I}}]});return{pass:S=>{const F={view:a,resolveTarget:e.getCurrentTexture().createView(),loadOp:"load",clearValue:vn.black,storeOp:"store"},E=S.beginRenderPass({colorAttachments:[F],depthStencilAttachment:{view:i,depthLoadOp:"load",depthClearValue:1,depthStoreOp:"store"}});E.setPipeline(p),E.setIndexBuffer(v,"uint32"),E.setVertexBuffer(0,s),E.setVertexBuffer(1,l),E.setVertexBuffer(2,f),E.setBindGroup(0,x),E.drawIndexed(m*3,_),E.end()}}},qn=4,ts=n=>{const e=qn/2,t=ye(n.position),r=[u(-e,-e,e,1),u(-e,e,e,1),u(e,e,e,1),u(e,-e,e,1),u(-e,-e,-e,1),u(-e,e,-e,1),u(e,e,-e,1),u(e,-e,-e,1)],i=[u(3,0,4),u(4,7,3),u(6,5,1),u(1,2,6)],a=[...Array(6).fill(u(0,1,0,0)),...Array(6).fill(u(0,-1,0,0))],o=[w(1,0),w(.5,0),w(.5,.5),w(.5,.5),w(1,.5),w(1,0),w(.5,.5),w(0,.5),w(0,0),w(0,0),w(.5,0),w(.5,.5)],s=[w(.5,1),w(.5,.5),w(0,.5),w(0,.5),w(0,1),w(.5,1)];n.cardinality&Y.NORTH||(i.push(u(1,0,3),u(3,2,1)),a.push(...Array(6).fill(u(0,0,-1,0))),o.push(...s)),n.cardinality&Y.EAST||(i.push(u(2,3,7),u(7,6,2)),a.push(...Array(6).fill(u(-1,0,0,0))),o.push(...s)),n.cardinality&Y.SOUTH||(i.push(u(4,5,6),u(6,7,4)),a.push(...Array(6).fill(u(0,0,1,0))),o.push(...s)),n.cardinality&Y.WEST||(i.push(u(5,4,0),u(0,1,5)),a.push(...Array(6).fill(u(1,0,0,0))),o.push(...s));const c=new Float32Array(T(i.reduce((h,v)=>{for(let m=0;m<3;m++)h.push(G(r[v[m]],u(...t,0)));return h},[]))),l=new Float32Array(T(a)),d=new Float32Array(T(o));let f=[];return n.type===mn.LIGHT&&(f=[Qo(n)]),{vertices:c,normals:l,uvs:d,lights:f}},rs=(n,e)=>{const r=G(ye(e.position),b(-qn/2*.96,0,-qn/2*.96)),i=G(ye(e.position),b(+qn/2*.96,0,+qn/2*.96));e.cardinality&Y.WEST&&(r[0]=-1/0),e.cardinality&Y.SOUTH&&(r[2]=-1/0),e.cardinality&Y.EAST&&(i[0]=1/0),e.cardinality&Y.NORTH&&(i[2]=1/0),n[0]=Fe(n[0],r[0],i[0]),n[2]=Fe(n[2],r[2],i[2])},is=n=>{const e=Ve(b(0,0,0),1),{buffer:t,bufferLayout:r}=$(n,new Float32Array(T(e.vertices)),"float32x4",0),{buffer:i}=Cn(n,new Uint32Array(T(e.triangleIndices.map(o=>Ln(o))))),a=o=>{const s=yn(G(o,b(0,-.5,0))),c=Gn(1,2,1),l=M(s,c);J(n,t,new Float32Array(T(e.vertices.map(d=>Oe(d,l)))),0)};return{bufferedMesh:{vertexBuffer:t,vertexBufferLayout:r,indexBuffer:i,vertexCount:e.vertices.length,triangleCount:e.triangleCount},updateMesh:a}},as=({device:n})=>{const e=b(0,0,0),t=b(0,0,1),r=Eo(e,t),i=n.createBuffer({size:Rn.float32x4x4,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});J(n,i,new Float32Array(nn(bt(r))),0);const a=n.createBuffer({size:Rn.float32x3,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});J(n,a,new Float32Array(b()),0);const{bufferedMesh:o,updateMesh:s}=is(n);return{camera:r,position:e,lookDirection:t,right:He(b(0,1,0),t),playerMoveListeners:[s],playerViewListeners:[],shadowBufferedMesh:o,playerPerspectiveBuffer:i,playerPositionBuffer:a}},Kt=({device:n},e,t,r)=>{let i=-t/512,a=r/512;e.lookDirection[1]>.97&&(a=Math.max(0,a)),e.lookDirection[1]<-.97&&(a=Math.min(0,a));const o=Yt(b(0,1,0),i),s=Yt(e.right,a),c=Xe(o,s);e.lookDirection=jn(Ln(Be(u(...e.lookDirection,1),c))),e.right=jn(He(Qt.up,e.lookDirection)),zr(n,e)},zr=(n,e)=>{e.camera.extrinsics=Fr(e.position,e.lookDirection);const t=bt(e.camera);for(const r of e.playerViewListeners)r(t);J(n,e.playerPerspectiveBuffer,new Float32Array(nn(bt(e.camera))),0)},os=({device:n},e,t,r)=>{const i=Ge(r.w)-Ge(r.s),a=Ge(r.a)-Ge(r.d),o=r.v;if(!i&&!a)return;const s=cs(e,i,a,o);t.cheats.noClip||rs(s,t.currentTile),e.position=s;for(const c of e.playerMoveListeners)c(e.position);J(n,e.playerPositionBuffer,new Float32Array(e.position),0),zr(n,e)},ss=.1,cs=(n,e,t,r)=>{let i=b();const a=(r?2:1)*ss;if(e){const o=[...n.lookDirection];o[1]=0;const s=Jn(jn(o),a*e);i=G(i,s)}if(t){const o=[...n.right];o[1]=0;const s=Jn(jn(o),a*t);i=G(i,s)}return G(n.position,i)},ls=`@group(0) @binding(0) var<uniform> projection_view : mat4x4f;\r
...
`,fs=(n,e)=>({direction:e,position:n,intensity:4,tint:b(35/100,50/100,9/100),active:!1}),us=n=>{const e=u(...ye(n.position),0),t=Er(n.cardinality),r=yt[t],i=2,a=Jn(r,qn/2-.1);let o=[u(-i,i,0,1),u(-i,-i,0,1),u(i,-i,0,1),u(i,i,0,1)];(t===Y.EAST||t===Y.WEST)&&(o=o.map(d=>Oe(d,Ee(90))));const s=new Uint32Array(T([b(0,1,3),b(3,1,2)])),c=new Float32Array(T([w(0,0),w(0,1),w(1,1),w(1,0)])),l=new Float32Array(T([r,r,r,r]));return{vertices:new Float32Array(T(o)),triangles:s,uvs:c,normals:l,lights:[fs(G(e,a),r)],modelMatrix:yn(Ln(G(e,a)))}},ds=async({device:n,mainCanvas:{context:e,canvasFormat:t,depthData:{depthStencil:r,depthStencilTextureView:i},multisampleData:{msaaTextureView:a,multisample:o}}},s,{playerPerspectiveBuffer:c})=>{const{texture:l,sampler:d}=await $e(n,"game/portal.png"),{buffer:f}=Cn(n,s.triangles),{buffer:h,bufferLayout:v}=$(n,s.vertices,"float32x4"),{buffer:m,bufferLayout:_}=$(n,s.normals,"float32x4",1),{buffer:g,bufferLayout:L}=$(n,s.uvs,"float32x2",2),I=tn(n,[v,_,L],t,ls,"triangle-list",{primitive:{frontFace:"ccw",cullMode:"none"},depthStencil:r,multisample:o},{blend:{color:{operation:"add",srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"zero"}}}),p=new Float32Array(nn(s.modelMatrix)),y=n.createBuffer({size:p.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});n.queue.writeBuffer(y,0,p);const A=new Float32Array([0]),x=n.createBuffer({size:A.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});n.queue.writeBuffer(x,0,A);const O=n.createBindGroup({layout:I.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:c}},{binding:1,resource:{buffer:y}},{binding:2,resource:{buffer:x}}]}),S=Un(n,I,l,d,1);return{pass:(E,V)=>{J(n,x,new Float32Array([V]),0);const B={view:a,resolveTarget:e.getCurrentTexture().createView(),loadOp:"load",storeOp:"store"},R=E.beginRenderPass({colorAttachments:[B],depthStencilAttachment:{view:i,depthLoadOp:"load",depthClearValue:1,depthStoreOp:"store"}});R.setPipeline(I),R.setIndexBuffer(f,"uint32"),R.setVertexBuffer(0,h),R.setVertexBuffer(1,m),R.setVertexBuffer(2,g),R.setBindGroup(0,O),R.setBindGroup(1,S),R.drawIndexed(6),R.end()}}},hs=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on("game"),i=4,{multisample:a,msaaTexture:o}=Ie(n,r,t,i),s=n.createTexture({size:{width:r.width,height:r.height},format:"depth24plus",sampleCount:i,usage:GPUTextureUsage.RENDER_ATTACHMENT}),c={depthWriteEnabled:!0,depthCompare:"less",format:"depth24plus"},l=[],d=(v,m)=>{v=Fe(v,-36,36),m=Fe(m,-36,36);for(const g of l)g(v,m)};let f=!1;const{keyMap:h}=Vi("game",d,{onStart:()=>f=!0,onEnd:()=>f=!1});return{device:n,mainCanvas:{context:e,canvasFormat:t,depthData:{depthStencil:c,depthStencilTextureView:s.createView()},multisampleData:{multisample:a,msaaTextureView:o.createView()}},input:{keyMap:h,mouseMoveListeners:l,inGame:f}}},_s=(n,e)=>{const t=qo(n.map,e.position);if(t!==n.currentTile&&t!==null){n.currentTile=t;for(const r of n.tileChangeListeners)r(ye(t.position),t.position);t.type===mn.END&&window.alert("you got to the end yay")}},vs=async()=>{const n=await hs(),e=as(n);n.input.mouseMoveListeners.push((p,y)=>Kt(n,e,p,y));const{tileSet:t,tileMap:r}=jo(),i=Ho(t.allTiles),a={map:r,currentTile:null,tileChangeListeners:[],cheats:{noClip:!1}},{buffer:o,bufferLayout:s}=$(n.device,i.vertices,"float32x4",0),c={vertexBuffer:o,vertexBufferLayout:s,vertexCount:i.vertices.length/4},l=us(t.endTile),d=ns(n,i.lights),{renderable:f,lightData:h}=Ko(n,[...i.lights,...l.lights],[c,e.shadowBufferedMesh,d]);a.tileChangeListeners.push(f.onTileChange);const{pass:v}=await $o(n,i,h,e),{pass:m}=await ds(n,l,e),{pass:_}=es(n,d,e,h),g=()=>{os(n,e,a,n.input.keyMap),n.input.keyMap.p&&(a.cheats.noClip=!a.cheats.noClip,n.input.keyMap.p=!1,console.info("[cheats]: no clip toggled to",a.cheats.noClip))};Kt(n,e,0,0);let L=0;const I=p=>{g(),_s(a,e);const y=n.device.createCommandEncoder();f.pass(y,p,L),v(y,p,L),m(y,p,L),_(y,p,L),n.device.queue.submit([y.finish()]),L++,requestAnimationFrame(I)};requestAnimationFrame(I)},ms=(n,e)=>{const t=en(),r=K("game");t.append(r),n.append(t),e.push(vs)},ps=(n,e)=>{if(!Je.children)throw"Graphics routes do not exist";for(const t of Je.children.map(r=>r.generator))t(n,e)},Je={path:"graphics",name:"Graphics",description:"",generator:ps,children:[{path:"webgpu-basics",name:"Introduction to the basics",description:"A walkthrough the basics of graphics and setting it up in WebGPU.",generator:Ua},{path:"drawing",name:"Drawing via interaction",description:"Using the browser interaction features to create a simple drawing application.",generator:Ha},{path:"projection",name:"Projection types",description:"An overview of the types of projections and GPU instancing.",generator:no},{path:"lighting",name:"Lighting",description:"Showcase of the most common GPU lighting models and runtime mesh creation.",generator:ro},{path:"meshes",name:"Mesh intstantiation",description:"Populating mesh data in the GPU and displaying a model in the frame.",generator:oo},{path:"texturing",name:"Applying textures",description:"Using textures to add colors to a mesh and an overview of the WebGPU process mipmapping.",generator:vo},{path:"env-mapping",name:"Environmental mapping",description:"Using environmental maps to populate color values reflected by mirror surfaces (with or without normal maps).",generator:xo},{path:"shadows",name:"Shadows (projection)",description:"Creating shadows in the scene using projective shadowing.",generator:wo},{path:"shadow-mapping",name:"Shadows (maps)",description:"Creating shadows in the scene using shadow maps.",generator:To},{path:"camera-movement",name:"Other interaction types",description:"A showcase of other scene interaction methods.",generator:Fo},{path:"game",name:"A simple game engine (project)",description:"Using the graphics toolset to create a simple dungeon crawler with focus on lighting, shadow maps and player movement.",generator:ms}]},gs=`struct Ray {
    origin : vec3f,
    direction : vec3f,
    tmin : f32,
    tmax : f32
...
`,Cr="raycast-anatomy",xs=async()=>{const{device:n,context:e,canvasFormat:t}=await on(Cr),r=tn(n,[],t,gs,"triangle-strip"),{pass:i,executePass:a}=dn(n,e,vn.black);i.setPipeline(r),i.draw(4),a()},bs=(n,e)=>{const t=an("The anatomy of a ray cast"),r=rn("No description yet"),i=K(Cr);n.append(t,r,i),e.push(xs)},ys=`struct ViewboxOptions {
    camera_constant : f32,
    aspect_ratio : f32
};
...
`,Gr="light",kr="zoom",Ur="light-intensity-slider",Nr="light-position-x-input",jr="light-position-y-input",Dr="light-position-z-input",Hr="shade-all-visible-objects",qr="refractive-index-slider",ws=async()=>{const{device:n,context:e,canvas:t,canvasFormat:r}=await on(Gr),i=k(kr),a=k(Ur),o=k(qr),s=k(Nr),c=k(jr),l=k(Dr),d=k(Hr,"checked"),f=t.width/t.height,h=tn(n,[],r,ys,"triangle-strip"),{bindGroup:v,buffers:[m]}=z(n,h,[new Float32Array([i(),f])],"UNIFORM"),_=new Float32Array([s(),c(),l(),a(),d()?1:0,o(),0,0]),{bindGroup:g,buffers:[L]}=z(n,h,[_],"UNIFORM",1),I=()=>{J(n,m,new Float32Array([i(),f]),0),J(n,L,new Float32Array([s(),c(),l(),a(),d()?1:0,o(),0,0]),0);const{pass:p,executePass:y}=dn(n,e,vn.black);p.setPipeline(h),p.setBindGroup(0,v),p.setBindGroup(1,g),p.draw(4),y(),requestAnimationFrame(I)};requestAnimationFrame(I)},Ls=(n,e)=>{const t=an("A simple lighting system"),r=rn("No description yet"),i=en(),a=K(Gr,{width:512+128,height:512-64}),o=hn(),s=P(ln(kr,1,.1,10,.1),"Zoom (camera constant)"),c=P(ln(Ur,3.14,0,10,.01),"Light intensity"),l=P(ln(qr,1,-1,10,.1),"Diffuse reflectance"),d=P(ln(Nr,0,-5,5,.1),"Light X position"),f=P(ln(jr,1,0,5,.1),"Light Y position"),h=P(ln(Dr,0,-5,5,.1),"Light Z position"),v=P(ne(Hr,!0),"Shading on",!1);o.append(s,c,l,d,f,h,v),i.append(a,o),n.append(t,r,i),e.push(ws)},$r=(n,e)=>{bs(n,e),Ls(n,e)},Is=`struct ViewboxOptions {
    aspect_ratio : f32
};
...
`,ze="lighting",Xr=ze+"-light-position-x-input",Yr=ze+"-light-position-y-input",Wr=ze+"-light-position-z-input",As=async()=>{const{device:n,context:e,canvas:t,canvasFormat:r}=await on(ze),i=k(Xr),a=k(Yr),o=k(Wr),s=t.width/t.height,c=tn(n,[],r,Is,"triangle-strip"),l=new Float32Array([s]),{bindGroup:d}=z(n,c,[l],"UNIFORM"),f=new Float32Array([i(),a(),o(),0,0,0,0,0,0]),{bindGroup:h,buffers:[v]}=z(n,c,[f],"UNIFORM",1),m=()=>{J(n,v,new Float32Array([i(),a(),o(),0,0,0,0,0,0]),0);const{pass:_,executePass:g}=dn(n,e,vn.black);_.setPipeline(c),_.setBindGroup(0,d),_.setBindGroup(1,h),_.draw(4),g(),requestAnimationFrame(m)};requestAnimationFrame(m)},Ss=(n,e)=>{const t=an("A simple lighting system"),r=rn("No description yet"),i=en(),a=K(ze,{width:512+128,height:512-64}),o=hn(),s=P(ln(Xr,0,-5,5,.1),"Light X position"),c=P(ln(Yr,1,0,5,.1),"Light Y position"),l=P(ln(Wr,0,-5,5,.1),"Light Z position");o.append(s,c,l),i.append(a,o),n.append(t,r,i),e.push(As)},Rs=`struct Environment {
    aspect_ratio : f32,
    time : f32
};
...
`,oe="mirrors",ie={"Base color":0,Lambertian:1,Mirror:2,Refractive:3,Phong:4,Glossy:5},Jr=oe+"-sphere-shader",Zr=oe+"-triangle-shader",Kr=oe+"-plane-shader",Qr=oe+"-light-position-x-input",ni=oe+"-light-position-y-input",ei=oe+"-light-position-z-input",ti=oe+"-animation-slider",Ts=async()=>{const{device:n,context:e,canvas:t,canvasFormat:r}=await on(oe),i=k(Qr),a=k(ni),o=k(ei),s=k(Jr),c=k(Zr),l=k(Kr),d=k(ti),f=t.width/t.height,h=tn(n,[],r,Rs,"triangle-strip"),v=new Float32Array([f,0]),{bindGroup:m,buffers:[_]}=z(n,h,[v],"UNIFORM"),g=new Float32Array([i(),a(),o(),ie[s()],ie[c()],ie[l()],0,0,0]),{bindGroup:L,buffers:[I]}=z(n,h,[g],"UNIFORM",1),p=y=>{J(n,_,new Float32Array([f,y*d()/512]),0),J(n,I,new Float32Array([i(),a(),o(),ie[s()],ie[c()],ie[l()],0,0,0]),0);const{pass:A,executePass:x}=dn(n,e,vn.black);A.setPipeline(h),A.setBindGroup(0,m),A.setBindGroup(1,L),A.draw(4),x(),requestAnimationFrame(p)};requestAnimationFrame(p)},Bs=(n,e)=>{const t=an("Mirrors"),r=rn("No description yet"),i=en(),a=K(oe,{width:512+128,height:512-64}),o=hn(),s=P(Bn(Jr,Object.keys(ie),"Refractive"),"Sphere shader type",!1),c=P(Bn(Zr,Object.keys(ie),"Lambertian"),"Triangle shader type",!1),l=P(Bn(Kr,Object.keys(ie),"Lambertian"),"Plane shader type",!1),d=P(ln(Qr,0,-5,5,.1),"Light X position"),f=P(ln(ni,1,0,5,.1),"Light Y position"),h=P(ln(ei,0,-5,5,.1),"Light Z position"),v=P(ln(ti,0,0,1,.1),"Orbit animation speed");o.append(s,c,l,d,f,h,v),i.append(a,o),n.append(t,r,i),e.push(Ts)},ri=(n,e)=>{Ss(n,e),Bs(n,e)},Ps=`@group(0) @binding(0) var texture_sampler : sampler;
...
`,ii="texture",ai="texture-repeat-style",Os=["clamp-to-edge","repeat","mirror-repeat"],Fs=async()=>{const{device:n,context:e,canvasFormat:t}=await on(ii),r=async i=>{const a=tn(n,[],t,Ps,"triangle-strip"),{textureData:o,height:s,width:c}=await le("textures/grass_minecraft.png"),{texture:l,sampler:d}=Kn(n,o,c,s,{addressModeU:i,addressModeV:i}),f=Un(n,a,l,d),{pass:h,executePass:v}=dn(n,e,vn.black);h.setPipeline(a),h.setBindGroup(0,f),h.draw(4),v()};r(wn(ai,r))},Es=(n,e)=>{const t=an("What is a texture"),r=rn("No description yet"),i=en(),a=K(ii),o=hn(),s=P(Bn(ai,Os,"repeat"),"Texture edge behavior",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(Fs)},Ms=`@group(0) @binding(0) var texture_sampler : sampler;
@group(0) @binding(1) var grass_texture : texture_2d<f32>;
...
`,oi="texturing",Lt="grass-texture-scale",je="subdivision-jitter-slider",It="grass-texture-select",si="texture-repeat-style-on-plane",Vs=["clamp-to-edge","repeat","mirror-repeat"],zs=async()=>{const{device:n,canvas:e,context:t,canvasFormat:r}=await on(oi),i=k(Lt),a=k(je),o=k(It),s=tn(n,[],r,Ms,"triangle-strip");let c,l;const d=async I=>{const p=[le("textures/grass.jpg"),le("textures/grass_minecraft.png")],y=await Promise.all(p),{texture:A,sampler:x}=Kn(n,y[0].textureData,y[0].width,y[0].height,{addressModeU:I,addressModeV:I}),{texture:O,sampler:S}=Kn(n,y[1].textureData,y[1].width,y[1].height,{addressModeU:I,addressModeV:I});c=Un(n,s,A,x),l=Un(n,s,O,S)};await d("repeat");const{bindGroup:f,buffers:[h]}=z(n,s,[new Float32Array([i(),a()*a()])],"UNIFORM",1),{bindGroup:v,buffers:[m]}=z(n,s,[new Float32Array(200)],"STORAGE",2),_=()=>{J(n,h,new Float32Array([i(),a()*a()]),0);const I={"grass.jpg":c,"grass_minecraft.png":l}[o()],{pass:p,executePass:y}=dn(n,t,vn.black);p.setPipeline(s),p.setBindGroup(0,I),p.setBindGroup(1,f),p.setBindGroup(2,v),p.draw(4),y()},g=I=>{const p=tr(e.height,I);J(n,m,new Float32Array(T(p)),0,!0)},L=wn(je,g);g(L),Ft([Lt,It,je],_),wn(si,async I=>{await d(I),_()}),_()},Cs=(n,e)=>{const t=an("Applying textures in rendering"),r=rn("No description yet"),i=en(),a=K(oi),o=hn(),s=P(ln(Lt,.2,.1,2,.1),"Texture scale"),c=P(ln(je,1,1,10,1),"Subdivisions for stratisfied jitter"),l=P(Bn(It,["grass.jpg","grass_minecraft.png"],"grass_minecraft.png"),"Grass texture",!1),d=P(Bn(si,Vs,"repeat"),"Texture edge behavior",!1);o.append(l,s,d,c),i.append(a,o),n.append(t,r,i),e.push(zs)},ci=(n,e)=>{Es(n,e),Cs(n,e)},Gs=`@group(0) @binding(0) var texture_sampler : sampler;
@group(0) @binding(1) var grass_texture : texture_2d<f32>;
...
`,li="default-scene-as-meshes",ks=async()=>{const{device:n,context:e,canvasFormat:t}=await on(li),r=tn(n,[],t,Gs,"triangle-strip"),i=ki([b(-.2,.1,.9),b(.2,.1,.9),b(-.2,.1,-.1)]),{bindGroup:a}=z(n,r,[new Float32Array(T(i.vertices)),new Uint32Array(T(i.triangleIndices))],"STORAGE",1),o=await le("textures/grass_minecraft.png"),{texture:s,sampler:c}=Kn(n,o.textureData,o.width,o.height,{addressModeU:"repeat",addressModeV:"repeat"}),l=Un(n,r,s,c);(()=>{const{pass:f,executePass:h}=dn(n,e,vn.black);f.setPipeline(r),f.setBindGroup(0,l),f.setBindGroup(1,a),f.draw(4),h()})()},Us=(n,e)=>{const t=an("Replacing the triangle with a triangle"),r=rn("No description yet"),i=en(),a=K(li),o=hn();i.append(a,o),n.append(t,r,i),e.push(ks)},Ns=`@group(0) @binding(0) var<storage> ut_vertices : array<vec3f>;
...
`,fi="utah-teapot",js=["Flat","Vertex normals"],ui="shading-select-ut",Ds=async()=>{const{device:n,context:e,canvasFormat:t}=await on(fi),r=tn(n,[],t,Ns,"triangle-strip"),i=await $n("models/teapot.obj"),a=rr(i,{}),{bindGroup:o}=z(n,r,[new Float32Array(T(a.vertices)),new Uint32Array(T(a.triangleIndices)),new Float32Array(T(a.normals))],"STORAGE",0),{bindGroup:s,buffers:[c]}=z(n,r,[new Uint32Array([a.triangleCount,0])],"UNIFORM",1),l=f=>{const h={Flat:0,"Vertex normals":1};Vn(n,c,new Uint32Array([h[f]]),4);const{pass:v,executePass:m}=dn(n,e,Re(.8,.4,.4,1));v.setPipeline(r),v.setBindGroup(0,o),v.setBindGroup(1,s),v.draw(4),m()},d=wn(ui,l);l(d)},Hs=(n,e)=>{const t=an("Introducing the Utah Teapot"),r=rn("No description yet"),i=en(),a=K(fi,{width:840,height:450}),o=hn(),s=P(Bn(ui,js,"Flat"),"Shading type",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(Ds)},qs=`@group(0) @binding(0) var<storage> cb_vertices : array<vec3f>;
...
`,di="cornell-box",$s=["Flat","Lambertian"],hi="shading-select-cb",Xs=async()=>{const{device:n,context:e,canvasFormat:t}=await on(di),r=tn(n,[],t,qs,"triangle-strip"),i=await $n("models/CornellBoxWithBlocks.obj"),a=rr(i,{}),o=new Float32Array(i.mtls[0].materials.reduce((m,_)=>[...m,...T([_.color,_.specular,_.emission,u(_.illum,_.shininess,_.ior)])],[])),s=a.materialIndices.reduce((m,_,g)=>(i.mtls[0].materials[_].illum>=1&&m.push(g),m),[]),{bindGroup:c}=z(n,r,[new Float32Array(T(a.vertices)),new Uint32Array(T(a.triangleIndices)),new Uint32Array(a.materialIndices),new Uint32Array(s)],"STORAGE",0),{bindGroup:l,buffers:[d]}=z(n,r,[new Uint32Array([a.triangleCount,s.length,0])],"UNIFORM",1),{bindGroup:f}=z(n,r,[o],"STORAGE",2),h=m=>{const _={Flat:0,Lambertian:1}[m];Vn(n,d,new Uint32Array([_]),2*4);const{pass:g,executePass:L}=dn(n,e,vn.black);g.setPipeline(r),g.setBindGroup(0,c),g.setBindGroup(1,l),g.setBindGroup(2,f),g.draw(4),L()},v=wn(hi,h);h(v)},Ys=(n,e)=>{const t=an("Inside the Cornell box"),r=rn("No description yet"),i=en(),a=K(di),o=hn(),s=P(Bn(hi,$s,"Lambertian"),"Shading type",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(Xs)},_i=(n,e)=>{Us(n,e),Hs(n,e),Ys(n,e)},Ws=`@group(0) @binding(0) var<storage> vertices : array<vec3f>;
...
`,vi="bsp",mi="animation-speed-bsp",Js=async()=>{const{device:n,context:e,canvasFormat:t}=await on(vi),r=k(mi),i=tn(n,[],t,Ws,"triangle-strip"),a=ee(await $n("models/bunny.obj",1)),o=ve(a),{bindGroup:s}=z(n,i,[o.vertices,o.normals,o.indices],"STORAGE"),{bindGroup:c}=z(n,i,[o.bspPlanes,o.bspTree,o.treeIds],"STORAGE",1),{bindGroup:l,buffers:[d,f]}=z(n,i,[o.aabb,new Float32Array([0])],"UNIFORM",2);let h=0;const v=()=>{h+=.025*r(),J(n,f,new Float32Array([h]),0);const{pass:m,executePass:_}=dn(n,e,vn.black);m.setPipeline(i),m.setBindGroup(0,s),m.setBindGroup(1,c),m.setBindGroup(2,l),m.draw(4),_(),requestAnimationFrame(v)};requestAnimationFrame(v)},Zs=(n,e)=>{const t=an("Using the Binary Space Partitioning tree"),r=rn("why dots in black?"),i=en(),a=K(vi),o=hn(),s=P(ln(mi,0,0,1,.01),"Speed of the animation");o.append(s),i.append(a,o),n.append(t,r,i),e.push(Js)},Ks=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,gi="cornell-glass",xi="jittering-active-bsp-cb",tc=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(gi),i=tn(n,[],t,ec,"triangle-strip"),a=ee(await $n("models/CornellBox.obj")),o=ve(a),s=we([o.vertices,o.normals]),c=new Uint32Array(o.indices);Le(c,a.matIndices,4);const l=new Uint32Array(a.lightIndices),d=new Float32Array(a.materials.reduce((A,x)=>[...A,...T([x.color,x.specular,x.emission,u(x.illum,x.shininess,x.ior)])],[])),{bindGroup:f}=z(n,i,[s,c,l],"STORAGE"),{bindGroup:h}=z(n,i,[o.bspPlanes,o.bspTree,o.treeIds],"STORAGE",1),{bindGroup:v,buffers:[m,_,g]}=z(n,i,[o.aabb,new Uint32Array([l.length]),new Uint32Array([36])],"UNIFORM",2),L=tr(r.height,6),{bindGroup:I}=z(n,i,[d,new Float32Array(T(L))],"STORAGE",3);wn(xi,A=>{const x=A?36:1;Vn(n,g,new Uint32Array([x]),0),y()},"checked");const y=()=>{const{pass:A,executePass:x}=dn(n,e,vn.black);A.setPipeline(i),A.setBindGroup(0,f),A.setBindGroup(1,h),A.setBindGroup(2,v),A.setBindGroup(3,I),A.draw(4),x()};y()},rc=(n,e)=>{const t=an("Spicing things up"),r=rn("No description yet"),i=en(),a=K(gi),o=hn(),s=P(ne(xi,!0),"Jittering enabled",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(tc)},ic=(n,e)=>{Zs(n,e),nc(n,e),rc(n,e)},ac=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,bi="cornell-progressive",At="progressive-enabled-cb",yi="select-shader-cb-progressive",cc=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(bi),i=k(At,"checked"),a=ee(await $n("models/CornellBoxWithBlocks.obj")),o=ve(a),s=we([o.vertices,o.normals]),c=new Uint32Array(o.indices);Le(c,a.matIndices,4);const l=new Uint32Array(a.lightIndices),d=new Float32Array(a.materials.reduce((m,_)=>[...m,...T([_.color,_.specular,_.emission,u(_.illum,_.shininess,_.ior)])],[])),f={"Simple progressive":ac,"Simple progressive with soft shadows":oc,"Complex progressive":sc},h={f:()=>{}},v=m=>{const{renderSrc:_,renderDst:g,blitPingPong:L}=Ze(n,r),I=n.createShaderModule({code:f[m]}),p=n.createRenderPipeline({layout:"auto",vertex:{module:I,entryPoint:"main_vs"},fragment:{module:I,entryPoint:"main_fs",targets:[{format:t},{format:"rgba32float"}]},primitive:{topology:"triangle-strip"}}),{bindGroup:y}=z(n,p,[s,c,l,d],"STORAGE"),{bindGroup:A}=z(n,p,[o.bspPlanes,o.bspTree,o.treeIds],"STORAGE",1),{bindGroup:x,buffers:[O,S,F]}=z(n,p,[o.aabb,new Uint32Array([l.length]),new Uint32Array([0,r.width,r.height])],"UNIFORM",2),E=n.createBindGroup({layout:p.getBindGroupLayout(3),entries:[{binding:0,resource:g.createView()}]});let V=0;const B=()=>{if(!i())return;V+=1,Vn(n,F,new Uint32Array([V]),0);const{pass:R,encoder:H}=dn(n,e,vn.black,{otherColorAttachments:[{view:_.createView(),loadOp:"load",storeOp:"store"}]});R.setPipeline(p),R.setBindGroup(0,y),R.setBindGroup(1,A),R.setBindGroup(2,x),R.setBindGroup(3,E),R.draw(4),R.end(),L(H),n.queue.submit([H.finish()]),requestAnimationFrame(B)};h.f=()=>requestAnimationFrame(B),requestAnimationFrame(B)};v(wn(yi,v)),wn(At,()=>h.f(),"checked")},lc=(n,e)=>{const t=an("Progressive rendering, the basics"),r=rn("No description yet"),i=en(),a=K(bi),o=hn(),s=P(ne(At,!0),"Progressive rendering enabled",!1),c=P(Bn(yi,["Simple progressive","Simple progressive with soft shadows","Complex progressive"],"Complex progressive"),"Progressive shader type",!1);o.append(s,c),i.append(a,o),n.append(t,r,i),e.push(cc)},wi=(n,e)=>{lc(n,e)},fc=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,Ut="brdfs",St="progressive-enabled-cb-"+Ut,Li="brdf-color-picker",uc=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(Ut),i=k(St,"checked"),a=k(Li),o=ee(await $n("models/CornellBox.obj")),s=ve(o),c=we([s.vertices,s.normals]),l=new Uint32Array(s.indices);Le(l,o.matIndices,4);const d=new Uint32Array(o.lightIndices),f=new Float32Array(o.materials.reduce((B,R)=>[...B,...T([R.color,R.specular,R.emission,u(R.illum,R.shininess,R.ior)])],[]));let{renderSrc:h,renderDst:v,blitPingPong:m}=Ze(n,r);const _=n.createShaderModule({code:fc}),g=n.createRenderPipeline({layout:"auto",vertex:{module:_,entryPoint:"main_vs"},fragment:{module:_,entryPoint:"main_fs",targets:[{format:t},{format:"rgba32float"}]},primitive:{topology:"triangle-strip"}}),{bindGroup:L}=z(n,g,[c,l,d,f],"STORAGE"),{bindGroup:I}=z(n,g,[s.bspPlanes,s.bspTree,s.treeIds],"STORAGE",1),{bindGroup:p,buffers:[y,A,x,O]}=z(n,g,[s.aabb,new Uint32Array([d.length]),new Uint32Array([0,r.width,r.height]),new Float32Array(qe(ce(a())))],"UNIFORM",2),S=n.createBindGroup({layout:g.getBindGroupLayout(3),entries:[{binding:0,resource:v.createView()}]});let F=0;const E=()=>{if(!i())return;V===!0&&(V=!1,F=0),F+=1,Vn(n,x,new Uint32Array([F]),0),J(n,O,new Float32Array(qe(ce(a()))),0);const{pass:B,encoder:R}=dn(n,e,vn.black,{otherColorAttachments:[{view:h.createView(),loadOp:"load",storeOp:"store"}]});B.setPipeline(g),B.setBindGroup(0,L),B.setBindGroup(1,I),B.setBindGroup(2,p),B.setBindGroup(3,S),B.draw(4),B.end(),m(R),n.queue.submit([R.finish()]),requestAnimationFrame(E)};wn(St,B=>{B&&requestAnimationFrame(E)},"checked");let V=!1;Ot("restart-progressive-brdf",()=>V=!0),E()},dc=(n,e)=>{const t=an("Progressive rendering, the basics"),r=rn("No description yet"),i=en(),a=K(Ut),o=hn(),s=P(ne(St,!0),"Progressive rendering enabled",!1),c=P(De(Li,"#1a3205"),"Sphere extinction coefficient"),l=Pt("restart-progressive-brdf","Restart progressive");o.append(s,c,l),i.append(a,o),n.append(t,r,i),e.push(uc)},Ii=(n,e)=>{dc(n,e)},hc=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,pc=`@group(0) @binding(0) var<storage, read_write> debug_canvas : array<vec4f>;
