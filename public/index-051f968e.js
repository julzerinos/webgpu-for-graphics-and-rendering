...
`,Oa=async()=>{const{device:n,canvas:e,context:t,canvasFormat:r}=await on("task1"),i=[].concat(T(ge([0,0],10*(2/e.height))),T(ge([1,0],10*(2/e.height))),T(ge([1,1],10*(2/e.height)))),a=new Float32Array(i),{buffer:o,bufferLayout:s}=$(n,a,"float32x2"),c=tn(n,[s],r,Pa),{pass:l,executePass:d}=dn(n,t,{r:.3921,g:.5843,b:.9294,a:1});l.setPipeline(c),l.setVertexBuffer(0,o),l.draw(i.length/2),d()},Fa=(n,e)=>{const t=an("Hello (GPU) world"),r=rn(`
...
`,_r="wireframe",vr="wireframe-rotation-slider",Ya=async()=>{const{device:n,context:e,canvasFormat:t}=await on(_r),r=Ve(b(0),1),i=r.lineIndices,a=new Float32Array(T(r.vertices)),{buffer:o}=Cn(n,i),{buffer:s,bufferLayout:c}=$(n,a,"float32x4"),l=tn(n,[c],t,Xa,"line-list"),{bindGroup:d,buffers:[f]}=z(n,l,[new Float32Array(nn(xn()))],"UNIFORM",0),h=yn(b(.5,.5,.5)),v=b(0,0,10),m=b(0),_=b(0,1,0),g=Fn(v,m,_),L=ji(-1.5,1.5,-1.5,1.5,0,100),I=M(kt,L),p=M(I,g),y=x=>{const O=Pe(x,b(1,1,1)),S=M(O,h),F=M(p,S);J(n,f,new Float32Array(nn(F)),0);const{pass:E,executePass:V}=dn(n,e,vn.black);E.setPipeline(l),E.setVertexBuffer(0,s),E.setIndexBuffer(o,"uint32"),E.setBindGroup(0,d),E.drawIndexed(i.length),V()},A=wn(vr,y);y(A)},Wa=(n,e)=>{const t=an("Projecting a cube"),r=rn(`
...
`,pr="airplane",gr="yaw-slider-airplane",xr="pitch-slider-airplane",br="roll-slider-airplane",no=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await on(pr),i=k(gr),a=k(xr),o=k(br),s=Ve(b(0),1),c=s.lineIndices,l=new Float32Array(T(s.vertices)),{buffer:d}=Cn(n,c),{buffer:f,bufferLayout:h}=$(n,l,"float32x4"),v=tn(n,[h],t,Qa,"line-list"),m=b(5,5,5),_=b(0),g=b(0,1,0),L=Fn(m,_,g),I=Qn(35,r.width/r.height,.1,100),p=M(kt,I),{bindGroup:y,buffers:[A]}=z(n,v,[new Float32Array([0,0,0,0,...nn(L),...nn(p)])],"UNIFORM",0),x=[],O=Gn(.4,.4,2),S=M(Gn(.35,.25,.35),yn(b(0,-.2,3.3))),F=M(Gn(1.7,.2,1.1),yn(b(.6))),E=M(Gn(1.7,.2,1.1),yn(b(-.6))),V=M(Gn(.2,.5,.3),yn(b(0,.5,-3.3))),B=M(Gn(.5,.1,.2),yn(b(-.9,.4,-4.3))),R=M(Gn(.5,.1,.2),yn(b(.9,.4,-4.3))),H=[O,S,F,E,V,B,R];x.push(...new Array(H.length).fill(u(.7,.7,.7)));const sn=(gn=xn())=>M(M(Gn(.1,.3,.2),gn),yn(b(0,.5,-6)));x.push(u(0,1,0));const cn=(gn=xn())=>M(M(Gn(.25,.05,.2),gn),yn(b(2,.4,-5.3))),U=(gn=xn())=>M(M(Gn(.25,.05,.2),gn),yn(b(-2,.4,-5.3)));x.push(u(1,0,0),u(1,0,0));const X=(gn=xn())=>M(M(yn(b(-1,.1,-.5)),gn),Gn(1,.1,.3)),W=(gn=xn())=>M(M(yn(b(1,.1,-.5)),gn),Gn(1,.1,.3));x.push(u(.4,.4,1),u(.4,.4,1));const C=[...H,sn(),cn(),U(),X(),W()],{bindGroup:q,buffers:Q}=z(n,v,[new Float32Array(be(C)),new Float32Array(T(x))],"STORAGE",1);let pn=0,bn=0,Z=0,fn=0,_n=0,j=0;const D=.1,En=gn=>{J(n,A,new Float32Array([gn]),0);const Xn=1*i();fn=fn*(1-D)+Xn*D,pn+=fn;const Pn=1*a();_n=_n*(1-D)+Pn*D,bn+=_n;const ue=1*o();j=j*(1-D)+ue*D,Z+=j;const On=Ee(-fn*20),te=Te(-_n*20),de=j>0?Te(j*60):xn(),me=j<0?Te(-j*60):xn(),Nn=M(M(Te(bn),Ee(pn)),Di(Z)),N=[...H.map(Yn=>M(Nn,Yn)),M(Nn,sn(On)),M(Nn,cn(te)),M(Nn,U(te)),M(Nn,X(de)),M(Nn,W(me))],un=N.map(Yn=>M(Nn,Yn));J(n,Q[0],new Float32Array(be(un)),0);const{pass:In,executePass:he}=dn(n,e,vn.black);In.setPipeline(v),In.setVertexBuffer(0,f),In.setIndexBuffer(d,"uint32"),In.setBindGroup(0,y),In.setBindGroup(1,q),In.drawIndexed(c.length,N.length),he(),requestAnimationFrame(En)};requestAnimationFrame(En)},eo=(n,e)=>{const t=an("About Gimbal's lock"),r=rn(`
...
`,Ro=`@group(0) @binding(0) var<uniform> model : mat4x4f;
...
`,Ye="shadow-mapping",Or="teapot-movement-shadow-mapping",Fr="light-movement-shadow-mapping",To=async()=>{const n=k(Or,"checked"),e=k(Fr,"checked"),t=await le("textures/xamp23.png"),r=await $n("models/teapot.obj",.25,!1),i=ee(r,{indicesIn3:!0}),{device:a,context:o,canvasFormat:s,canvas:c}=await on(Ye),l=document.getElementById(Ye+"-shadow"),d=l.getContext("gpupresent")||l.getContext("webgpu");d.configure({device:a,format:s});const{depthStencil:f,depthStencilAttachmentFactory:h}=fe(a,c,1),{buffer:v}=Cn(a,i.indices),{buffer:m,bufferLayout:_}=$(a,i.vertices,"float32x4"),{buffer:g,bufferLayout:L}=$(a,i.normals,"float32x4",1),{buffer:I,bufferLayout:p}=$(a,i.colors,"float32x4",2),y=tn(a,[_,L,p],s,So,"triangle-list",{depthStencil:f}),A=a.createTexture({size:{width:l.width,height:l.height,depthOrArrayLayers:1},mipLevelCount:1,sampleCount:1,dimension:"2d",format:"rgba32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),x=A.createView(),O=a.createShaderModule({code:Ro}),S=a.createRenderPipeline({layout:"auto",vertex:{module:O,entryPoint:"main_vs",buffers:[_]},fragment:{module:O,entryPoint:"main_fs",targets:[{format:s},{format:"rgba32float"}]},primitive:{cullMode:"none",topology:"triangle-list"}}),{bindGroup:F,buffers:[E,V]}=z(a,S,[new Float32Array(nn(xn())),new Float32Array(nn(kn()))],"UNIFORM",0),B=new Uint32Array([0,1,2,0,2,3]),R=new Float32Array(T([w(0,0),w(1,0),w(1,1),w(0,1)])),H=new Float32Array(T([u(-2,-1,-1),u(2,-1,-1),u(2,-1,-5),u(-2,-1,-5)])),{buffer:sn}=Cn(a,new Uint32Array([...B])),{buffer:cn,bufferLayout:U}=$(a,new Float32Array([...H]),"float32x4"),{buffer:X,bufferLayout:W}=$(a,new Float32Array([...R]),"float32x2",1),C=tn(a,[U,W],s,Ao,"triangle-list",{depthStencil:f}),q=a.createBindGroup({layout:C.getBindGroupLayout(2),entries:[{binding:0,resource:A.createView()}]}),Q=new Float32Array(nn(Qn(90,1,.001,6))),pn=N=>{const un=Qn(100,1,.01,4),In=Fn(N,b(0,-1,-3),er.up);return M(un,In)},bn=N=>{const un=new Float32Array(nn(pn(N)));J(a,V,un,0),J(a,_n,un,0)},{bindGroup:Z,buffers:[fn,_n,j]}=z(a,C,[Q,new Float32Array(nn(kn())),new Float32Array(nn(kn()))],"UNIFORM",1),D=Ct(t.textureData,t.width),{texture:En,sampler:gn}=Kn(a,t.textureData,t.width,t.height,{addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",minFilter:"nearest",magFilter:"nearest",mipmapFilter:"nearest"},{mips:D}),Xn=Un(a,C,En,gn),{bindGroup:Pn,buffers:[ue,On]}=z(a,y,[new Float32Array(nn(kn())),new Float32Array(b()),Q],"UNIFORM",0);let te=0,de=0,me=0;const Nn=N=>{const un=(N-me)/1e3;te+=n()?un:0,de+=e()?un:0;const In=b(2*Math.cos(de),2,2*Math.sin(de)-2);J(a,On,new Float32Array(In),0),bn(In);const he=yn(b(0,(Math.cos(te)*3-1)/4,-3)),Yn=new Float32Array(nn(he));J(a,ue,Yn,0),J(a,E,Yn,0),J(a,j,Yn,0);const Ae=a.createCommandEncoder(),se=Ae.beginRenderPass({colorAttachments:[{view:d.getCurrentTexture().createView(),loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"},{view:x,loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"}]});se.setPipeline(S),se.setVertexBuffer(0,m),se.setIndexBuffer(v,"uint32"),se.setBindGroup(0,F),se.drawIndexed(i.indices.length),se.end();const Tn=Ae.beginRenderPass({colorAttachments:[{view:o.getCurrentTexture().createView(),loadOp:"clear",clearValue:vn.blueScreenBlue,storeOp:"store"}],depthStencilAttachment:h()});Tn.setPipeline(C),Tn.setVertexBuffer(0,cn),Tn.setVertexBuffer(1,X),Tn.setIndexBuffer(sn,"uint32"),Tn.setBindGroup(0,Xn),Tn.setBindGroup(1,Z),Tn.setBindGroup(2,q),Tn.drawIndexed(6),Tn.setPipeline(y),Tn.setVertexBuffer(0,m),Tn.setVertexBuffer(1,g),Tn.setVertexBuffer(2,I),Tn.setIndexBuffer(v,"uint32"),Tn.setBindGroup(0,Pn),Tn.drawIndexed(i.indices.length),Tn.end(),a.queue.submit([Ae.finish()]),me=N,requestAnimationFrame(Nn)};requestAnimationFrame(Nn)},Bo=(n,e)=>{const t=an("shadow mapping"),r=rn("https://toolness.github.io/shadowmap-2d/"),i=en(),a=K(Ye),o=hn(),s=P(ne(Or,!0),"Teapot movement",!1),c=P(ne(Fr,!0),"Light movement",!1);o.append(s,c),i.append(a,o);const l=en(),d=K(Ye+"-shadow");l.append(d),n.append(t,r,i,l),e.push(To)},Po=(n,e)=>{Bo(n,e)},Oo=`struct SceneData {
    pvm : mat4x4f,
    observer : vec4f,
};
...
`,ze="lighting",Wr=ze+"-light-position-x-input",Jr=ze+"-light-position-y-input",Zr=ze+"-light-position-z-input",Rs=async()=>{const{device:n,context:e,canvas:t,canvasFormat:r}=await on(ze),i=k(Wr),a=k(Jr),o=k(Zr),s=t.width/t.height,c=tn(n,[],r,Ss,"triangle-strip"),l=new Float32Array([s]),{bindGroup:d}=z(n,c,[l],"UNIFORM"),f=new Float32Array([i(),a(),o(),0,0,0,0,0,0]),{bindGroup:h,buffers:[v]}=z(n,c,[f],"UNIFORM",1),m=()=>{J(n,v,new Float32Array([i(),a(),o(),0,0,0,0,0,0]),0);const{pass:_,executePass:g}=dn(n,e,vn.black);_.setPipeline(c),_.setBindGroup(0,d),_.setBindGroup(1,h),_.draw(4),g(),requestAnimationFrame(m)};requestAnimationFrame(m)},Ts=(n,e)=>{const t=an("A simple lighting system"),r=rn("No description yet"),i=en(),a=K(ze,{width:512+128,height:512-64}),o=hn(),s=P(ln(Wr,0,-5,5,.1),"Light X position"),c=P(ln(Jr,1,0,5,.1),"Light Y position"),l=P(ln(Zr,0,-5,5,.1),"Light Z position");o.append(s,c,l),i.append(a,o),n.append(t,r,i),e.push(Rs)},Bs=`struct Environment {
    aspect_ratio : f32,
    time : f32
};
