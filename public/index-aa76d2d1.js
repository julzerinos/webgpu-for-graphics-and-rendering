...
`,Ca=async()=>{const{device:n,context:e,canvasFormat:t}=await cn("task2"),{pass:r,executePass:i}=un(n,e,{r:.3921,g:.5843,b:.9294,a:1}),a=[y(0,0),y(1,0),y(1,1)],o=[b(1,0,0),b(0,1,0),b(0,0,1)],s=new Float32Array(B(a)),c=new Float32Array(B(o)),{buffer:l,bufferLayout:h}=H(n,s,"float32x2"),{buffer:f,bufferLayout:d}=H(n,c,"float32x3",1),_=nn(n,[h,d],t,za);r.setPipeline(_),r.setVertexBuffer(0,l),r.setVertexBuffer(1,f),r.draw(a.length),i()},ka=(n,e)=>{const t=on("A formal introduction to the triangle"),r=an(`
...
`,Da=async()=>{const{device:n,context:e,canvasFormat:t}=await cn("task4"),r=be(y(0,0),2),i=new Float32Array(B(r)),a=G("ball-height"),o=G("ball-size"),s=G("ball-speed"),{bufferLayout:c,buffer:l}=H(n,i,"float32x2"),h=nn(n,[c],t,Na),{bindGroup:f,buffers:[d]}=z(n,h,[new Float32Array([0])],"UNIFORM"),{bindGroup:_,buffers:[m]}=z(n,h,[new Float32Array(3)],"UNIFORM",1),v=g=>{W(n,d,new Float32Array([g/1e3]),0),W(n,m,new Float32Array([a(),s(),o()]),0);const{pass:L,executePass:I}=un(n,e,mn.blueScreenBlue);L.setPipeline(h),L.setVertexBuffer(0,l),L.setBindGroup(0,f),L.setBindGroup(1,_),L.draw(r.length),I(),requestAnimationFrame(v)};requestAnimationFrame(v)},Ha=(n,e)=>{const t=on("Interacting with a scene"),r=an(`
...
`),i=tn(),a=en(ct),o=_n(),s=it("display-draw-instruction"),c=Fn(lt,Ya),l=P(He(lr,"#000000"),"Draw color"),h=P(He(fr,"#ffffff"),"Background color"),f=P(fn(hr,10,2,100),"Point size"),d=P(fn(ur,12,4,32),"Circle granularity"),_=Ft(dr,"Clear canvas");o.append(s,c,l,f,d,h,_),i.append(a,o),n.append(t,r,i),e.push(Xa)},Ja=`struct Uniforms {
    mvp : mat4x4f,
};
...
`,vr="wireframe",_r="wireframe-rotation-slider",Za=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(vr),r=ze(b(0),1),i=r.lineIndices,a=new Float32Array(B(r.vertices)),{buffer:o}=Vn(n,i),{buffer:s,bufferLayout:c}=H(n,a,"float32x4"),l=nn(n,[c],t,Ja,"line-list"),{bindGroup:h,buffers:[f]}=z(n,l,[new Float32Array(K(wn()))],"UNIFORM",0),d=yn(b(.5,.5,.5)),_=b(0,0,10),m=b(0),v=b(0,1,0),g=Cn(_,m,v),L=qi(-1.5,1.5,-1.5,1.5,0,100),I=M(Ut,L),p=M(I,g),w=x=>{const O=Oe(x,b(1,1,1)),S=M(O,d),F=M(p,S);W(n,f,new Float32Array(K(F)),0);const{pass:E,executePass:V}=un(n,e,mn.black);E.setPipeline(l),E.setVertexBuffer(0,s),E.setIndexBuffer(o,"uint32"),E.setBindGroup(0,h),E.drawIndexed(i.length),V()},A=An(_r,w);w(A)},Ka=(n,e)=>{const t=on("Projecting a cube"),r=an(`
...
`,mr="perspective",no=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(mr),i=ze(b(0),1),a=new Float32Array(B(i.vertices)),o=i.lineIndices,{buffer:s}=Vn(n,o),{buffer:c,bufferLayout:l}=H(n,a,"float32x4"),{buffer:h,bufferLayout:f}=H(n,new Float32Array(B([u(.5,.5,.5,1),u(0,0,1,1),u(0,1,0,1),u(0,1,1,1),u(1,0,1,1),u(1,0,0,1),u(1,1,0,1),u(1,1,1,1)])),"float32x4",1),d=nn(n,[l,f],t,Qa,"line-list"),_=b(0,0,5),m=b(0),v=b(0,1,0),g=Cn(_,m,v),L=re(45,r.width/r.height,.1,100),I=M(Ut,L),p=M(I,g),w=M(Oe(0,b(1,1,1)),yn(b(-2))),A=M(Oe(45,b(0,1,0)),yn(b(0))),x=M(yn(b(2)),Oe(45,b(1,1,0))),O=M(p,w),S=M(p,A),F=M(p,x),{bindGroup:E}=z(n,d,[new Float32Array(we([O,S,F]))],"UNIFORM",0);(()=>{const{pass:R,executePass:T}=un(n,e,mn.black);R.setPipeline(d),R.setVertexBuffer(0,c),R.setVertexBuffer(1,h),R.setIndexBuffer(s,"uint32"),R.setBindGroup(0,E),R.drawIndexed(o.length,3),T()})()},eo=(n,e)=>{const t=on("Considering different perspectives"),r=an(`
...
`,pr="airplane",gr="yaw-slider-airplane",xr="pitch-slider-airplane",br="roll-slider-airplane",ro=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(pr),i=G(gr),a=G(xr),o=G(br),s=ze(b(0),1),c=s.lineIndices,l=new Float32Array(B(s.vertices)),{buffer:h}=Vn(n,c),{buffer:f,bufferLayout:d}=H(n,l,"float32x4"),_=nn(n,[d],t,to,"line-list"),m=b(5,5,5),v=b(0),g=b(0,1,0),L=Cn(m,v,g),I=re(35,r.width/r.height,.1,100),p=M(Ut,I),{bindGroup:w,buffers:[A]}=z(n,_,[new Float32Array([0,0,0,0,...K(L),...K(p)])],"UNIFORM",0),x=[],O=Nn(.4,.4,2),S=M(Nn(.35,.25,.35),yn(b(0,-.2,3.3))),F=M(Nn(1.7,.2,1.1),yn(b(.6))),E=M(Nn(1.7,.2,1.1),yn(b(-.6))),V=M(Nn(.2,.5,.3),yn(b(0,.5,-3.3))),R=M(Nn(.5,.1,.2),yn(b(-.9,.4,-4.3))),T=M(Nn(.5,.1,.2),yn(b(.9,.4,-4.3))),q=[O,S,F,E,V,R,T];x.push(...new Array(q.length).fill(u(.7,.7,.7)));const rn=(gn=wn())=>M(M(Nn(.1,.3,.2),gn),yn(b(0,.5,-6)));x.push(u(0,1,0));const sn=(gn=wn())=>M(M(Nn(.25,.05,.2),gn),yn(b(2,.4,-5.3))),U=(gn=wn())=>M(M(Nn(.25,.05,.2),gn),yn(b(-2,.4,-5.3)));x.push(u(1,0,0),u(1,0,0));const Y=(gn=wn())=>M(M(yn(b(-1,.1,-.5)),gn),Nn(1,.1,.3)),X=(gn=wn())=>M(M(yn(b(1,.1,-.5)),gn),Nn(1,.1,.3));x.push(u(.4,.4,1),u(.4,.4,1));const C=[...q,rn(),sn(),U(),Y(),X()],{bindGroup:$,buffers:Q}=z(n,_,[new Float32Array(we(C)),new Float32Array(B(x))],"STORAGE",1);let pn=0,bn=0,Z=0,ln=0,hn=0,j=0;const N=.1,Mn=gn=>{W(n,A,new Float32Array([gn]),0);const En=1*i();ln=ln*(1-N)+En*N,pn+=ln;const Ln=1*a();hn=hn*(1-N)+Ln*N,bn+=hn;const Yn=1*o();j=j*(1-N)+Yn*N,Z+=j;const In=Ee(-ln*20),dn=Re(-hn*20),oe=j>0?Re(j*60):wn(),ge=j<0?Re(-j*60):wn(),Dn=M(M(Re(bn),Ee(pn)),$i(Z)),D=[...q.map(ne=>M(Dn,ne)),M(Dn,rn(In)),M(Dn,sn(dn)),M(Dn,U(dn)),M(Dn,Y(oe)),M(Dn,X(ge))],vn=D.map(ne=>M(Dn,ne));W(n,Q[0],new Float32Array(we(vn)),0);const{pass:Tn,executePass:ve}=un(n,e,mn.black);Tn.setPipeline(_),Tn.setVertexBuffer(0,f),Tn.setIndexBuffer(h,"uint32"),Tn.setBindGroup(0,w),Tn.setBindGroup(1,$),Tn.drawIndexed(c.length,D.length),ve(),requestAnimationFrame(Mn)};requestAnimationFrame(Mn)},io=(n,e)=>{const t=on("About Gimbal's lock"),r=an(`
...
`,yr="graphics-lighting",Ne="rotation-around-tetrahedron",ft="subdivision-tetrahedron",wr="tetrahedron-rotation-animation-enabled",ut="diffuse-reflectance-tetrahedron",ht="specular-reflectance-tetrahedron",dt="ambient-reflectance-tetrahedron",vt="shading-type-tetrahedron",_t="shininess-tetrahedron",mt="tetrahedron-light-emission",so=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(yr),i=G(Ne),a=G(ft),o=G(vt),s=G(dt),c=G(ut),l=G(ht),h=G(_t),f=G(mt),d=new Array(8).fill(0).map((ln,hn)=>kt(hn)),{buffer:_}=Vn(n,new Uint32Array(B(d[7].triangleIndices.map(ln=>Sn(ln))))),{buffer:m,bufferLayout:v}=H(n,new Float32Array(B(d[7].vertices)),"float32x4"),{buffer:g,bufferLayout:L}=H(n,new Float32Array(B([u(1,0,0),u(0,1,0),u(0,0,1),u(1,1,1),...new Array(d[7].vertices.length-4).fill(u(.4,.4,.4))])),"float32x4",1);Gn(n,_,new Uint32Array(B(d[a()].triangleIndices.map(ln=>Sn(ln)))),0,!0);const I=4,{multisample:p,msaaTexture:w}=pe(n,r,t,I),{createDepthTexture:A,depthStencil:x,depthStencilAttachmentFactory:O}=ae(n,r,I),S=nn(n,[v,L],t,oo,"triangle-list",{multisample:p,depthStencil:x});A();const F=jn(i()),E=b(3*Math.sin(F),0,3*Math.cos(F)),V=b(0),R=b(0,1,0),T=Cn(E,V,R),rn=re(45,r.width/r.height,.1,100),U=M(rn,T),Y={"Gouraud shading (vertex)":0,"Phong shading (fragment)":1},{bindGroup:X,buffers:[C]}=z(n,S,[new Float32Array([...K(U),...u(...E),...$e(de(f())),...u(s(),c(),l(),h()),...u(Y[o()])])],"UNIFORM",0),$=ln=>{const hn=jn(ln),j=b(3*Math.sin(hn),0,3*Math.cos(hn)),N=Cn(j,V,R),gn=M(rn,N);W(n,C,new Float32Array([...K(gn),...u(...j)]),0)};An(ft,ln=>{Gn(n,_,new Uint32Array(B(d[ln].triangleIndices.map(hn=>Sn(hn)))),0,!0)}),An(Ne,$);let pn=!0;An(wr,()=>pn=document.getElementById(Ne).disabled=!pn),Et([vt,_t,ht,ut,dt,mt],()=>{W(n,C,new Float32Array([...$e(de(f())),...u(s(),c(),l(),h()),...u(Y[o()])]),80)});const Z=ln=>{pn&&$(ln/50);const{pass:hn,executePass:j}=un(n,e,u(.2,.2,.2),{depthStencilAttachmentFactory:O,msaaTexture:w});hn.setPipeline(S),hn.setVertexBuffer(0,m),hn.setVertexBuffer(1,g),hn.setIndexBuffer(_,"uint32"),hn.setBindGroup(0,X),hn.drawIndexed(d[a()].triangleCount*3),j(),requestAnimationFrame(Z)};requestAnimationFrame(Z)},co=(n,e)=>{const t=on("Shining light on tetrahedrons"),r=an(`
...
Between the two approaches to shading, Goroud is the definite winner in terms of efficiency with only as many computations as there are vertices, but it is vastly lower quality than Phong shading, especially for models with large triangles.
    `),i=tn(),a=en(yr),o=_n(),s=P(Qn(wr,!0),"Animated rotation",!1),c=fn(Ne,0,-180,180,1,!0),l=P(c,"Rotation around the tetrahedron"),h=P(fn(ft,4,0,7,1),"Number of tetrahedron subdivisions"),f=P(Fn(vt,["Gouraud shading (vertex)","Phong shading (fragment)"],"Gouraud shading"),"Shading type",!1),d=P(fn(ut,1,0,2,.1),"Diffuse reflectance"),_=P(fn(ht,1,0,2,.1),"Specular reflectance"),m=P(fn(_t,15,0,50,1),"Shininess"),v=P(fn(dt,.1,0,2,.1),"Ambient reflectance"),g=P(He(mt,"#ffffff"),"Light emission",!1);o.append(s,l,h,f,d,_,v,m,g),i.append(a,o),n.append(t,r,i),e.push(so)},lo=`struct SceneData {
    pvm : mat4x4f,
    observer : vec4f,
};
...
`,Lr="monkey",Ir="rotation-around-monkey",fo=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Lr),i=await $n(qn("models/monkey.obj"),1,!1),a=ie(i,{indicesIn3:!0}),{buffer:o}=Vn(n,a.indices),{buffer:s,bufferLayout:c}=H(n,a.vertices,"float32x4"),{buffer:l,bufferLayout:h}=H(n,a.normals,"float32x4",1),{msaaTexture:f,multisample:d}=pe(n,r,t,4),{createDepthTexture:_,depthStencil:m,depthStencilAttachmentFactory:v}=ae(n,r,4),g=nn(n,[c,h],t,lo,"triangle-list",{depthStencil:m,multisample:d,primitive:{frontFace:"ccw",cullMode:"back"}});_();const L=jn(0),I=4,p=0,w=b(I*Math.sin(L),p,I*Math.cos(L)),A=b(0),x=b(0,1,0),O=Cn(w,A,x),F=re(30,r.width/r.height,.1,100),E=M(F,O),V=wn(),R=M(E,V),{bindGroup:T,buffers:[q]}=z(n,g,[new Float32Array([...K(R),...w,1])],"UNIFORM",0);An(Ir,U=>{const Y=jn(U),X=b(I*Math.sin(Y),p,I*Math.cos(Y)),C=Cn(X,A,x),$=M(F,C),Q=M($,V);W(n,q,new Float32Array([...K(Q),...X,1]),0),sn()});const sn=()=>{const{pass:U,executePass:Y}=un(n,e,mn.black,{depthStencilAttachmentFactory:v,msaaTexture:f});U.setPipeline(g),U.setVertexBuffer(0,s),U.setVertexBuffer(1,l),U.setIndexBuffer(o,"uint32"),U.setBindGroup(0,T),U.drawIndexed(a.indices.length),Y()};sn()},uo=(n,e)=>{const t=on("The Blender Monkey"),r=an(`
...
Each following fragment's depth value to compared to the current closest fragment and it may either be discarded (if it is covered) or it may overwrite if it is the closer (to the viewer) fragment.
    `),i=tn(),a=en(Lr),o=_n(),s=P(fn(Ir,0,-180,180,1),"Rotation around the monkey");o.append(s),i.append(a,o),n.append(t,r,i),e.push(fo)},ho=`@group(0) @binding(0) var texture_sampler : sampler;
...
`,Ar="checkerboard-test",pt="texture-repeat-style",vo=["clamp-to-edge","repeat","mirror-repeat"],gt="magnification-checkerboard",xt="minification-checkerboard",rt=["linear","nearest"],_o=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(Ar),r=G(pt),i=G(xt),a=G(gt),o=G(bt),s=new Float32Array(B([u(-4,-1,-1),u(4,-1,-1),u(4,-1,-21),u(-4,-1,-21)])),c=new Uint32Array([0,1,2,0,2,3]),l=new Float32Array(B([y(-1.5,0),y(2.5,0),y(2.5,10),y(-1.5,10)])),{buffer:h}=Vn(n,c),{buffer:f,bufferLayout:d}=H(n,s,"float32x4"),{buffer:_,bufferLayout:m}=H(n,l,"float32x2",1),v=nn(n,[d,m],t,ho,"triangle-list"),g=Zi(64,8,8),L=Ke(g,64,!0),I=async()=>{const{texture:p,sampler:w}=Kn(n,g,64,64,{addressModeU:r(),addressModeV:r(),minFilter:i(),magFilter:a(),mipmapFilter:o()},{mips:L}),A=Un(n,v,p,w),{pass:x,executePass:O}=un(n,e,mn.blueScreenBlue);x.setPipeline(v),x.setVertexBuffer(0,f),x.setVertexBuffer(1,_),x.setIndexBuffer(h,"uint32"),x.setBindGroup(0,A),x.drawIndexed(6),O()};Et([pt,gt,xt,bt],I),I()},bt="mipmap-select-checkerboard",mo=(n,e)=>{const t=on("The unseen end of the checkers board"),r=an(`
...
`),i=tn(),a=en(Ar),o=_n(),s=P(Fn(pt,vo,"repeat"),"Texture edge behaviour",!1),c=P(Fn(xt,rt,"nearest"),"Minification behaviour",!1),l=P(Fn(gt,rt,"nearest"),"Magnification behaviour",!1),h=P(Fn(bt,rt,"nearest"),"Mipmap behaviour",!1);o.append(s,c,l,h),i.append(a,o),n.append(t,r,i),e.push(_o)},po=`struct SceneData {
    pvm : mat4x4f,
};
...
`,Sr="earth",go=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Sr),{textureData:i,width:a,height:o}=await le(qn("textures/earth.jpg")),s=kt(7),{buffer:c}=Vn(n,new Uint32Array(B(s.triangleIndices.map(X=>Sn(X))))),{buffer:l,bufferLayout:h}=H(n,new Float32Array(B(s.vertices)),"float32x4"),{buffer:f,bufferLayout:d}=H(n,new Float32Array(B([u(1,0,0),u(0,1,0),u(0,0,1),u(1,1,1),...new Array(s.vertices.length-4).fill(u(.4,.4,.4))])),"float32x4",1),_=4,{multisample:m,msaaTexture:v}=pe(n,r,t,_),{depthStencil:g,depthStencilAttachmentFactory:L}=ae(n,r,_),I=nn(n,[h,d],t,po,"triangle-list",{multisample:m,depthStencil:g}),{sampler:p,texture:w}=Kn(n,i,a,o,{minFilter:"nearest",magFilter:"nearest"}),A=Un(n,I,w,p,1),x=jn(0),O=b(3*Math.sin(x),0,3*Math.cos(x)),S=b(0),F=b(0,1,0),E=Cn(O,S,F),R=re(45,r.width/r.height,.1,100),q=M(R,E),{bindGroup:rn,buffers:[sn]}=z(n,I,[new Float32Array(K(q))],"UNIFORM",0),U=X=>{const C=jn(X),$=b(3*Math.sin(C),Math.cos(C),3*Math.cos(C)),Q=Cn($,S,F),bn=M(R,Q);W(n,sn,new Float32Array(K(bn)),0)},Y=X=>{U(X/50);const{pass:C,executePass:$}=un(n,e,u(.5,.1,.5),{depthStencilAttachmentFactory:L,msaaTexture:v});C.setPipeline(I),C.setVertexBuffer(0,l),C.setVertexBuffer(1,f),C.setIndexBuffer(c,"uint32"),C.setBindGroup(0,rn),C.setBindGroup(1,A),C.drawIndexed(s.triangleCount*3),$(),requestAnimationFrame(Y)};requestAnimationFrame(Y)},xo=(n,e)=>{const t=on("Earth ball"),r=an(`
...
`,Tr="texture-sphere-with-quad",Br="env-sphere-reflect-type",Rr={"Faux reflection":0,"Mirror reflection":1,"Show normal map":2,"Bump reflection":3},wo=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Tr),[i,...a]=await Promise.all(["textures/normalmap.png","textures/cubemap/cm_left.png","textures/cubemap/cm_right.png","textures/cubemap/cm_top.png","textures/cubemap/cm_bottom.png","textures/cubemap/cm_back.png","textures/cubemap/cm_front.png"].map(Ln=>le(qn(Ln)))),o=b(0,0,3),s=b(0),c=b(0,1,0),l=Cn(o,s,c),f=re(90,r.width/r.height,.1,100),d=M(f,l),_=Ht(f),m=Ht(l),v=Wi(m,[0,0],[3,3]),g=zn(),L=Ji(v,g),I=M(L,_),p=kt(7),w=B(p.triangleIndices.map(Ln=>Sn(Ln))),A=B(p.vertices.map(Ln=>Fe(Ln,d))),x=.999,O=B([u(-1,-1,x,1),u(1,-1,x,1),u(-1,1,x,1),u(1,1,x,1)]),S=[p.vertices.length+0,p.vertices.length+1,p.vertices.length+2,p.vertices.length+1,p.vertices.length+3,p.vertices.length+2],{buffer:F}=Vn(n,new Uint32Array([...w,...S])),{buffer:E,bufferLayout:V}=H(n,new Float32Array([...A,...O]),"float32x4"),{buffer:R,bufferLayout:T}=H(n,new Float32Array([...B(p.vertices),...O]),"float32x4",1),{buffer:q,bufferLayout:rn}=H(n,new Float32Array([...Array(p.vertices.length).fill(0),...Array(4).fill(1)]),"uint32",2),sn=4,{multisample:U,msaaTexture:Y}=pe(n,r,t,sn),{depthStencil:X,depthStencilAttachmentFactory:C}=ae(n,r,sn),$=nn(n,[V,T,rn],t,yo,"triangle-list",{multisample:U,depthStencil:X}),{sampler:Q,cubemapTexture:pn}=Fa(n,a.map(Ln=>Ln.textureData),a[0].width,a[0].height),bn=Un(n,$,pn,Q,0,{createViewOverwrite:{dimension:"cube"}}),{bindGroup:Z,buffers:[ln,hn,j]}=z(n,$,[new Float32Array(we([wn(),I])),new Float32Array([...o]),new Uint32Array([0])],"UNIFORM",1),{texture:N,sampler:Mn}=Kn(n,i.textureData,i.width,i.height),gn=Un(n,$,N,Mn,2),En=Ln=>{const Yn=Rr[Ln];Gn(n,j,new Uint32Array([Yn]),0);const{pass:In,executePass:dn}=un(n,e,u(.5,.1,.5),{depthStencilAttachmentFactory:C,msaaTexture:Y});In.setPipeline($),In.setVertexBuffer(0,E),In.setVertexBuffer(1,R),In.setVertexBuffer(2,q),In.setIndexBuffer(F,"uint32"),In.setBindGroup(0,bn),In.setBindGroup(1,Z),In.setBindGroup(2,gn),In.drawIndexed(p.triangleCount*3+S.length),dn()};En(An(Br,En))},Lo=(n,e)=>{const t=on("A map to the environment"),r=an(`
...
`,We="shadow-mapping",Er="teapot-movement-shadow-mapping",Vr="light-movement-shadow-mapping",zo=async()=>{const n=G(Er,"checked"),e=G(Vr,"checked"),t=await le(qn("textures/xamp23.png")),r=await $n(qn("models/teapot.obj"),.25,!1),i=ie(r,{indicesIn3:!0}),{device:a,context:o,canvasFormat:s,canvas:c}=await cn(We),l=document.getElementById(We+"-shadow"),h=l.getContext("gpupresent")||l.getContext("webgpu");h.configure({device:a,format:s});const{depthStencil:f,depthStencilAttachmentFactory:d}=ae(a,c,1),{buffer:_}=Vn(a,i.indices),{buffer:m,bufferLayout:v}=H(a,i.vertices,"float32x4"),{buffer:g,bufferLayout:L}=H(a,i.normals,"float32x4",1),{buffer:I,bufferLayout:p}=H(a,i.colors,"float32x4",2),w=nn(a,[v,L,p],s,Eo,"triangle-list",{depthStencil:f}),A=a.createTexture({size:{width:l.width,height:l.height,depthOrArrayLayers:1},mipLevelCount:1,sampleCount:1,dimension:"2d",format:"rgba32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),x=A.createView(),O=a.createShaderModule({code:Vo}),S=a.createRenderPipeline({layout:"auto",vertex:{module:O,entryPoint:"main_vs",buffers:[v]},fragment:{module:O,entryPoint:"main_fs",targets:[{format:s},{format:"rgba32float"}]},primitive:{cullMode:"none",topology:"triangle-list"}}),{bindGroup:F,buffers:[E,V]}=z(a,S,[new Float32Array(K(wn())),new Float32Array(K(zn()))],"UNIFORM",0),R=new Uint32Array([0,1,2,0,2,3]),T=new Float32Array(B([y(0,0),y(1,0),y(1,1),y(0,1)])),q=new Float32Array(B([u(-2,-1,-1),u(2,-1,-1),u(2,-1,-5),u(-2,-1,-5)])),{buffer:rn}=Vn(a,new Uint32Array([...R])),{buffer:sn,bufferLayout:U}=H(a,new Float32Array([...q]),"float32x4"),{buffer:Y,bufferLayout:X}=H(a,new Float32Array([...T]),"float32x2",1),C=nn(a,[U,X],s,Mo,"triangle-list",{depthStencil:f}),$=a.createBindGroup({layout:C.getBindGroupLayout(2),entries:[{binding:0,resource:A.createView()}]}),Q=new Float32Array(K(re(90,1,.001,6))),pn=D=>{const vn=re(100,1,.01,4),Tn=Cn(D,b(0,-1,-3),er.up);return M(vn,Tn)},bn=D=>{const vn=new Float32Array(K(pn(D)));W(a,V,vn,0),W(a,hn,vn,0)},{bindGroup:Z,buffers:[ln,hn,j]}=z(a,C,[Q,new Float32Array(K(zn())),new Float32Array(K(zn()))],"UNIFORM",1),N=Ke(t.textureData,t.width),{texture:Mn,sampler:gn}=Kn(a,t.textureData,t.width,t.height,{addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",minFilter:"nearest",magFilter:"nearest",mipmapFilter:"nearest"},{mips:N}),En=Un(a,C,Mn,gn),{bindGroup:Ln,buffers:[Yn,In]}=z(a,w,[new Float32Array(K(zn())),new Float32Array(b()),Q],"UNIFORM",0);let dn=0,oe=0,ge=0;const Dn=D=>{const vn=(D-ge)/1e3;dn+=n()?vn:0,oe+=e()?vn:0;const Tn=b(2*Math.cos(oe),2,2*Math.sin(oe)-2);W(a,In,new Float32Array(Tn),0),bn(Tn);const ve=yn(b(0,(Math.cos(dn)*3-1)/4,-3)),ne=new Float32Array(K(ve));W(a,Yn,ne,0),W(a,E,ne,0),W(a,j,ne,0);const Se=a.createCommandEncoder(),he=Se.beginRenderPass({colorAttachments:[{view:h.getCurrentTexture().createView(),loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"},{view:x,loadOp:"clear",clearValue:{r:0,g:0,b:0,a:1},storeOp:"store"}]});he.setPipeline(S),he.setVertexBuffer(0,m),he.setIndexBuffer(_,"uint32"),he.setBindGroup(0,F),he.drawIndexed(i.indices.length),he.end();const On=Se.beginRenderPass({colorAttachments:[{view:o.getCurrentTexture().createView(),loadOp:"clear",clearValue:mn.blueScreenBlue,storeOp:"store"}],depthStencilAttachment:d()});On.setPipeline(C),On.setVertexBuffer(0,sn),On.setVertexBuffer(1,Y),On.setIndexBuffer(rn,"uint32"),On.setBindGroup(0,En),On.setBindGroup(1,Z),On.setBindGroup(2,$),On.drawIndexed(6),On.setPipeline(w),On.setVertexBuffer(0,m),On.setVertexBuffer(1,g),On.setVertexBuffer(2,I),On.setIndexBuffer(_,"uint32"),On.setBindGroup(0,Ln),On.drawIndexed(i.indices.length),On.end(),a.queue.submit([Se.finish()]),ge=D,requestAnimationFrame(Dn)};requestAnimationFrame(Dn)},Co=(n,e)=>{const t=on("Tea time 2: the tea that wasn't"),r=an(`
...
`),i=tn(),a=en(We),o=_n(),s=P(Qn(Er,!0),"Teapot movement",!1),c=P(Qn(Vr,!0),"Light movement",!1);o.append(s,c),i.append(a,o);const l=tn(),h=en(We+"-shadow");l.append(h),n.append(t,r,i,l),e.push(zo)},ko=(n,e)=>{Fo(n,e),Co(n,e)},Go=`struct SceneData {
    pvm : mat4x4f,
    observer : vec4f,
};
...
`,yt="camera-movement",zr="movement-type-cam-movement",Uo=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(yt),i=G(zr),a=await $n(qn("models/monkey.obj"),1,!1),o=ie(a,{indicesIn3:!0}),{buffer:s}=Vn(n,o.indices),{buffer:c,bufferLayout:l}=H(n,o.vertices,"float32x4"),{buffer:h,bufferLayout:f}=H(n,o.normals,"float32x4",1),{msaaTexture:d,multisample:_}=pe(n,r,t,4),{depthStencil:m,depthStencilAttachmentFactory:v}=ae(n,r,4),g=nn(n,[l,f],t,Go,"triangle-list",{depthStencil:m,multisample:_}),L=b(0,0,5);let I=b(0,0,5);const p=b(0);let w=b();const A=b(0,1,0);let x=b(0,1,0);const O=Cn(L,p,A),F=re(30,r.width/r.height,.1,100),E=M(F,O),V=wn(),R=M(E,V),{bindGroup:T,buffers:[q]}=z(n,g,[new Float32Array([...K(R),...L,1])],"UNIFORM",0),rn=1,sn=.01;let U=i(),Y=0,X=0,C=0,$=0,Q=0,pn=0,bn=Aa();const Z=D=>se(D,0,512,-1,1);let ln=y(),hn=y(),j=0;const N=D=>{j=0,ln=y(D.x,D.y),En=0,Y=D.x,X=D.y,U=i()},Mn=D=>{if((U==="Dollying"||U==="Panning")&&(Q=sn*(D.x-Y),pn=-sn*(D.y-X)),U==="Quaternion rotation"||U==="Euler rotation"){C+=-rn*(D.x-Y),$+=-rn*(D.y-X);const vn=-Z(Y),Tn=Z(X),ve=-Z(D.x),ne=Z(D.y),Se=Math.sqrt(vn*vn+Tn*Tn),he=Math.sqrt(ve*ve+ne*ne),On=ke=>ke>1/Math.sqrt(2)?1/(2*ke):Math.sqrt(1-ke*ke),Vi=b(vn,Tn,On(Se)),zi=b(ve,ne,On(he)),Ci=Ba(Vi,zi);bn=Xe(bn,Ci)}Y=D.x,X=D.y},gn=D=>{if(Q=0,pn=0,U!=="Quaternion rotation"||(hn=y(D.x,D.y),rr(ln,hn)))return;const vn=_e(hn,ln);j=Math.min(Ct(vn),20)};let En=0;const Ln=()=>{if(U!=="Quaternion rotation"){j=0;return}Y=ln[0],X=ln[1];const D=j*Math.exp(-En/150),vn=k(ln,Zn(Hn(_e(hn,ln)),D));j<.2&&(j=0),En+=1,Mn({x:vn[0],y:vn[1]})};at(yt,{onStart:N,onMove:Mn,onEnd:gn});const Yn=()=>{const D=M(Re($),Ee(C)),vn=Fe(L,D),Tn=Fe(A,D);return{view:Cn(vn,p,Tn),eye:vn}},In=()=>{const D=Sn(Pe([...x,1],bn)),vn=Sn(Pe([...I,1],bn));return{view:Cn(vn,w,D),eye:vn}},dn=()=>(I[2]+=pn,In()),oe=()=>{const D=Zn(Sn(Pe(u(1),bn)),Q),vn=Zn(Sn(Pe(u(0,1),bn)),pn);return w=_e(w,k(D,vn)),In()},ge=()=>{const D={"Euler rotation":Yn,"Quaternion rotation":In,Dollying:dn,Panning:oe}[i()](),vn=M(F,D.view),Tn=M(vn,V);W(n,q,new Float32Array([...K(Tn),...D.eye,1]),0)},Dn=()=>{j>0&&Ln(),ge();const{pass:D,executePass:vn}=un(n,e,mn.black,{depthStencilAttachmentFactory:v,msaaTexture:d});D.setPipeline(g),D.setVertexBuffer(0,c),D.setVertexBuffer(1,h),D.setIndexBuffer(s,"uint32"),D.setBindGroup(0,T),D.drawIndexed(o.indices.length),vn(),requestAnimationFrame(Dn)};requestAnimationFrame(Dn)},jo=(n,e)=>{const t=on("Quaternions - engineering space magic"),r=an(`
...
`,qo={[J.NORTH]:J.SOUTH,[J.EAST]:J.WEST,[J.SOUTH]:J.NORTH,[J.WEST]:J.EAST},kr=n=>{const e=[];n&J.NORTH&&e.push(J.NORTH),n&J.EAST&&e.push(J.EAST),n&J.SOUTH&&e.push(J.SOUTH),n&J.WEST&&e.push(J.WEST);const t=Math.round(Math.random()*e.length-.5);return e[t]},Gr={1:y(0,1),2:y(1,0),4:y(0,-1),8:y(-1,0)},Lt={[J.NORTH]:u(0,0,1,0),[J.EAST]:u(1,0,0,0),[J.SOUTH]:u(0,0,-1,0),[J.WEST]:u(-1,0,0,0)},Wn=12,ee=(n,e,t)=>{n[e[0]][e[1]]=t},Je=(n,e)=>e[1]>=0&&e[1]<Wn&&e[0]>=0&&e[0]<Wn?n[e[0]][e[1]]:xn.OUT_OF_BOUNDS,Ue=(n,e)=>Je(n,e)===xn.EMPTY,Xn=(n,e)=>{const t=Je(n,e);return t===xn.EMPTY||t===xn.OUT_OF_BOUNDS},$o=(n,e,t)=>{switch(t){case J.NORTH:return Xn(n,k(e,y(-1,1)))&&Ue(n,k(e,y(0,1)))&&Xn(n,k(e,y(1,1)));case J.EAST:return Xn(n,k(e,y(1,1)))&&Ue(n,k(e,y(1,0)))&&Xn(n,k(e,y(1,-1)));case J.SOUTH:return Xn(n,k(e,y(-1,-1)))&&Ue(n,k(e,y(0,-1)))&&Xn(n,k(e,y(1,-1)));case J.WEST:return Xn(n,k(e,y(-1,1)))&&Ue(n,k(e,y(-1,0)))&&Xn(n,k(e,y(-1,-1)))}return!1},Yo=(n,e)=>{const t=!Xn(n,k(e,y(0,1)))&&!Xn(n,k(e,y(0,-1))),r=!Xn(n,k(e,y(1,0)))&&!Xn(n,k(e,y(-1,0)));return t||r},Xo=()=>Math.random()<.15?xn.LIGHT:xn.NORMAL,Wo=(n,e)=>(ee(n,k(e,y(1,0)),xn.NORMAL),ee(n,k(e,y(0,0)),xn.SPAWN),ee(n,k(e,y(-1,0)),xn.NORMAL),ee(n,k(e,y(1,1)),xn.LIGHT),ee(n,k(e,y(0,1)),xn.NORMAL),ee(n,k(e,y(-1,1)),xn.LIGHT),ee(n,k(e,y(1,2)),xn.NORMAL),ee(n,k(e,y(0,2)),xn.NORMAL),ee(n,k(e,y(-1,2)),xn.NORMAL),k(e,y(0,3))),Jo=()=>{const n=Array.from(Array(Wn).fill(null),()=>Array(Wn).fill(xn.EMPTY)),e=y(Wn/2,Wn/2),t=Wo(n,e);let r=!1;const i=a=>{const o=Yo(n,a),s=Xo();if(s===xn.EMPTY||o)return;ee(n,a,s);let c=0;const l=[J.NORTH,J.EAST,J.SOUTH,J.WEST];l.sort(()=>Math.sign(Math.random()*2-1));for(let h=0;h<4;h++){const f=l[h];if(!$o(n,a,f)||s===xn.LIGHT&&c>=3)continue;const d=k(a,Gr[f]);i(d),++c}c===0&&!r&&(ee(n,a,xn.END),r=!0)};return i(t),{map:n,center:e}},Zo=n=>{const e=[],t=[];let r=null;const i=Array.from(Array(Wn).fill(null),()=>Array(Wn).fill(null));for(let a=0;a<n.length;a++)for(let o=0;o<n[a].length;o++){const s=y(o,a),c=Je(n,s);if(c===xn.EMPTY)continue;let l=0;for(let f=0;f<4;f++){const d=1<<f,_=Je(n,k(s,Gr[d]));_!==xn.OUT_OF_BOUNDS&&_!==xn.EMPTY&&(l+=1<<f)}const h={position:s,cardinality:l,type:c};e.push(h),i[o][a]=h,c===xn.LIGHT&&t.push(h),c===xn.END&&(r=h)}return{tileSet:{allTiles:e,lightTiles:t,endTile:r},tileMap:i}},Ko=()=>{const{map:n,center:e}=Jo(),{tileSet:t,tileMap:r}=Zo(n);return{tileSet:t,tileMap:r,center:e}},Qo=n=>y(Math.round(n[0]/Jn+Wn/2),Math.round(n[2]/Jn+Wn/2)),Le=n=>b(Jn*(n[0]-Wn/2),0,Jn*(n[1]-Wn/2)),ns=n=>{let e=new Float32Array,t=new Float32Array,r=new Float32Array,i=[];for(const a of n){const o=hs(a);e=new Float32Array([...e,...o.vertices]),t=new Float32Array([...t,...o.normals]),r=new Float32Array([...r,...o.uvs]),i=[...i,...o.lights]}return{vertices:e,normals:t,uvs:r,lights:i}},es=(n,e)=>{const t=Qo(e),r=n[t[0]][t[1]];return r===null?(console.error("next does not exist"),null):r},ts=async({device:n,mainCanvas:{context:e,canvasFormat:t,depthData:{depthStencil:r,depthStencilTextureView:i},multisampleData:{msaaTextureView:a,multisample:o}}},s,{shadowMapTexture:c,lightSourcesBuffer:l,activeLightIndicesBuffer:h},{playerPerspectiveBuffer:f,playerPositionBuffer:d})=>{const{texture:_,sampler:m}=await Ye(n,"game/dungeon_textures_albedo.png"),{buffer:v,bufferLayout:g}=H(n,s.vertices,"float32x4"),{buffer:L,bufferLayout:I}=H(n,s.normals,"float32x4",1),{buffer:p,bufferLayout:w}=H(n,s.uvs,"float32x2",2),A=nn(n,[g,I,w],t,Ho,"triangle-list",{primitive:{frontFace:"ccw",cullMode:"front"},depthStencil:r,multisample:o},{blend:{color:{operation:"add",srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"zero"}}}),x=n.createBindGroup({layout:A.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:f}},{binding:1,resource:{buffer:d}}]}),O=Un(n,A,_,m,1),S=n.createBindGroup({layout:A.getBindGroupLayout(2),entries:[{binding:0,resource:{buffer:l}},{binding:1,resource:c.createView()},{binding:2,resource:{buffer:h}}]});return{pass:E=>{const V={view:a,resolveTarget:e.getCurrentTexture().createView(),loadOp:"clear",clearValue:mn.black,storeOp:"store"},R=E.beginRenderPass({colorAttachments:[V],depthStencilAttachment:{view:i,depthLoadOp:"clear",depthClearValue:1,depthStoreOp:"store"}});R.setPipeline(A),R.setVertexBuffer(0,v),R.setVertexBuffer(1,L),R.setVertexBuffer(2,p),R.setBindGroup(0,x),R.setBindGroup(1,O),R.setBindGroup(2,S),R.draw(s.vertices.length/4),R.end()}}},rs=`@group(0) @binding(0) var<uniform> projection_view : mat4x4f;\r
...
`,Nr="raycast-anatomy",Rs=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(Nr),r=nn(n,[],t,Bs,"triangle-strip"),{pass:i,executePass:a}=un(n,e,mn.black);i.setPipeline(r),i.draw(4),a()},Ps=(n,e)=>{const t=on("The anatomy of rendering"),r=an(`
...
`,Dr="light",Hr="zoom",qr="light-intensity-slider",$r="light-position-x-input",Yr="light-position-y-input",Xr="light-position-z-input",Wr="shade-all-visible-objects",Jr="refractive-index-slider",Fs=async()=>{const{device:n,context:e,canvas:t,canvasFormat:r}=await cn(Dr),i=G(Hr),a=G(qr),o=G(Jr),s=G($r),c=G(Yr),l=G(Xr),h=G(Wr,"checked"),f=t.width/t.height,d=nn(n,[],r,Os,"triangle-strip"),{bindGroup:_,buffers:[m]}=z(n,d,[new Float32Array([i(),f])],"UNIFORM"),v=new Float32Array([s(),c(),l(),a(),h()?1:0,o(),0,0]),{bindGroup:g,buffers:[L]}=z(n,d,[v],"UNIFORM",1),I=()=>{W(n,m,new Float32Array([i(),f]),0),W(n,L,new Float32Array([s(),c(),l(),a(),h()?1:0,o(),0,0]),0);const{pass:p,executePass:w}=un(n,e,mn.black);p.setPipeline(d),p.setBindGroup(0,_),p.setBindGroup(1,g),p.draw(4),w(),requestAnimationFrame(I)};requestAnimationFrame(I)},Ms=(n,e)=>{const t=on("Let there be light"),r=an(`
...
`,ue="mirrors",ce={"Base color":0,Lambertian:1,Mirror:2,Refractive:3,Phong:4,Glossy:5},ei=ue+"-sphere-shader",ti=ue+"-triangle-shader",ri=ue+"-plane-shader",ii=ue+"-light-position-x-input",ai=ue+"-light-position-y-input",oi=ue+"-light-position-z-input",si=ue+"-animation-slider",ks=async()=>{const{device:n,context:e,canvas:t,canvasFormat:r}=await cn(ue),i=G(ii),a=G(ai),o=G(oi),s=G(ei),c=G(ti),l=G(ri),h=G(si),f=t.width/t.height,d=nn(n,[],r,Cs,"triangle-strip"),_=new Float32Array([f,0]),{bindGroup:m,buffers:[v]}=z(n,d,[_],"UNIFORM"),g=new Float32Array([i(),a(),o(),ce[s()],ce[c()],ce[l()],0,0,0]),{bindGroup:L,buffers:[I]}=z(n,d,[g],"UNIFORM",1),p=w=>{W(n,v,new Float32Array([f,w*h()/512]),0),W(n,I,new Float32Array([i(),a(),o(),ce[s()],ce[c()],ce[l()],0,0,0]),0);const{pass:A,executePass:x}=un(n,e,mn.black);A.setPipeline(d),A.setBindGroup(0,m),A.setBindGroup(1,L),A.draw(4),x(),requestAnimationFrame(p)};requestAnimationFrame(p)},Gs=(n,e)=>{const t=on('Putting physics in "physically-based rendering"'),r=an(`
...
`,li="texture",fi="texture-repeat-style",js=["clamp-to-edge","repeat","mirror-repeat"],Ns=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(li),r=async i=>{const a=nn(n,[],t,Us,"triangle-strip"),{textureData:o,height:s,width:c}=await le(qn("textures/grass_minecraft.png")),{texture:l,sampler:h}=Kn(n,o,c,s,{addressModeU:i,addressModeV:i}),f=Un(n,a,l,h),{pass:d,executePass:_}=un(n,e,mn.black);d.setPipeline(a),d.setBindGroup(0,f),d.draw(4),_()};r(An(fi,r))},Ds=(n,e)=>{const t=on("Introducing textures"),r=an(`
...
`,ui="texturing",At="grass-texture-scale",De="subdivision-jitter-slider",St="grass-texture-select",hi="texture-repeat-style-on-plane",qs=["clamp-to-edge","repeat","mirror-repeat"],$s=async()=>{const{device:n,canvas:e,context:t,canvasFormat:r}=await cn(ui),i=G(At),a=G(De),o=G(St),s=nn(n,[],r,Hs,"triangle-strip");let c,l;const h=async I=>{const p=[le(qn("textures/grass.jpg")),le(qn("textures/grass_minecraft.png"))],w=await Promise.all(p),{texture:A,sampler:x}=Kn(n,w[0].textureData,w[0].width,w[0].height,{addressModeU:I,addressModeV:I}),{texture:O,sampler:S}=Kn(n,w[1].textureData,w[1].width,w[1].height,{addressModeU:I,addressModeV:I});c=Un(n,s,A,x),l=Un(n,s,O,S)};await h("repeat");const{bindGroup:f,buffers:[d]}=z(n,s,[new Float32Array([i(),a()*a()])],"UNIFORM",1),{bindGroup:_,buffers:[m]}=z(n,s,[new Float32Array(200)],"STORAGE",2),v=()=>{W(n,d,new Float32Array([i(),a()*a()]),0);const I={"grass.jpg":c,"grass_minecraft.png":l}[o()],{pass:p,executePass:w}=un(n,t,mn.black);p.setPipeline(s),p.setBindGroup(0,I),p.setBindGroup(1,f),p.setBindGroup(2,_),p.draw(4),w()},g=I=>{const p=ir(e.height,I);W(n,m,new Float32Array(B(p)),0,!0)},L=An(De,g);g(L),Et([At,St,De],v),An(hi,async I=>{await h(I),v()}),v()},Ys=(n,e)=>{const t=on("Textures in rendering, jittering to solve aliasing"),r=an(`
...
`),i=tn(),a=en(ui),o=_n(),s=P(fn(At,.2,.1,2,.1),"Texture scale"),c=P(fn(De,1,1,10,1),"Subdivisions for stratisfied jitter"),l=P(Fn(St,["grass.jpg","grass_minecraft.png"],"grass_minecraft.png"),"Grass texture",!1),h=P(Fn(hi,qs,"repeat"),"Texture edge behavior",!1);o.append(l,s,h,c),i.append(a,o),n.append(t,r,i),e.push($s)},di=(n,e)=>{Ds(n,e),Ys(n,e)},Xs=n=>{const e=on("Measuring light"),t=an(`
...
`),r=document.createElement("iframe");r.width="100%",r.height="1000px",r.src=qn("webgpu-for-graphics-and-rendering/resources/worksheet.pdf"),n.append(e,t,r)},Ws=(n,e)=>{Xs(n)},Js=`@group(0) @binding(0) var texture_sampler : sampler;
@group(0) @binding(1) var grass_texture : texture_2d<f32>;
...
`,vi="default-scene-as-meshes",Zs=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(vi),r=nn(n,[],t,Js,"triangle-strip"),i=Hi([b(-.2,.1,.9),b(.2,.1,.9),b(-.2,.1,-.1)]),{bindGroup:a}=z(n,r,[new Float32Array(B(i.vertices)),new Uint32Array(B(i.triangleIndices))],"STORAGE",1),o=await le("textures/grass_minecraft.png"),{texture:s,sampler:c}=Kn(n,o.textureData,o.width,o.height,{addressModeU:"repeat",addressModeV:"repeat"}),l=Un(n,r,s,c);(()=>{const{pass:f,executePass:d}=un(n,e,mn.black);f.setPipeline(r),f.setBindGroup(0,l),f.setBindGroup(1,a),f.draw(4),d()})()},Ks=(n,e)=>{const t=on("Replacing the triangle with a triangle"),r=an("No description yet"),i=tn(),a=en(vi),o=_n();i.append(a,o),n.append(t,r,i),e.push(Zs)},Qs=`@group(0) @binding(0) var<storage> ut_vertices : array<vec3f>;
...
`,_i="utah-teapot",nc=["Flat","Vertex normals"],mi="shading-select-ut",ec=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(_i),r=nn(n,[],t,Qs,"triangle-strip"),i=await $n("models/teapot.obj"),a=ar(i,{}),{bindGroup:o}=z(n,r,[new Float32Array(B(a.vertices)),new Uint32Array(B(a.triangleIndices)),new Float32Array(B(a.normals))],"STORAGE",0),{bindGroup:s,buffers:[c]}=z(n,r,[new Uint32Array([a.triangleCount,0])],"UNIFORM",1),l=f=>{const d={Flat:0,"Vertex normals":1};Gn(n,c,new Uint32Array([d[f]]),4);const{pass:_,executePass:m}=un(n,e,Be(.8,.4,.4,1));_.setPipeline(r),_.setBindGroup(0,o),_.setBindGroup(1,s),_.draw(4),m()},h=An(mi,l);l(h)},tc=(n,e)=>{const t=on("Introducing the Utah Teapot"),r=an("No description yet"),i=tn(),a=en(_i,{width:840,height:450}),o=_n(),s=P(Fn(mi,nc,"Flat"),"Shading type",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(ec)},rc=`@group(0) @binding(0) var<storage> cb_vertices : array<vec3f>;
...
`,pi="cornell-box",ic=["Flat","Lambertian"],gi="shading-select-cb",ac=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(pi),r=nn(n,[],t,rc,"triangle-strip"),i=await $n("models/CornellBoxWithBlocks.obj"),a=ar(i,{}),o=new Float32Array(i.mtls[0].materials.reduce((m,v)=>[...m,...B([v.color,v.specular,v.emission,u(v.illum,v.shininess,v.ior)])],[])),s=a.materialIndices.reduce((m,v,g)=>(i.mtls[0].materials[v].illum>=1&&m.push(g),m),[]),{bindGroup:c}=z(n,r,[new Float32Array(B(a.vertices)),new Uint32Array(B(a.triangleIndices)),new Uint32Array(a.materialIndices),new Uint32Array(s)],"STORAGE",0),{bindGroup:l,buffers:[h]}=z(n,r,[new Uint32Array([a.triangleCount,s.length,0])],"UNIFORM",1),{bindGroup:f}=z(n,r,[o],"STORAGE",2),d=m=>{const v={Flat:0,Lambertian:1}[m];Gn(n,h,new Uint32Array([v]),2*4);const{pass:g,executePass:L}=un(n,e,mn.black);g.setPipeline(r),g.setBindGroup(0,c),g.setBindGroup(1,l),g.setBindGroup(2,f),g.draw(4),L()},_=An(gi,d);d(_)},oc=(n,e)=>{const t=on("Inside the Cornell box"),r=an("No description yet"),i=tn(),a=en(pi),o=_n(),s=P(Fn(gi,ic,"Lambertian"),"Shading type",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(ac)},xi=(n,e)=>{Ks(n,e),tc(n,e),oc(n,e)},sc=`@group(0) @binding(0) var<storage> vertices : array<vec3f>;
...
`,wi="cornell-interleave",uc=async()=>{const{device:n,context:e,canvasFormat:t}=await cn(wi),r=nn(n,[],t,fc,"triangle-strip"),i=ie(await $n("models/CornellBoxWithBlocks.obj")),a=me(i),o=Ie([a.vertices,a.normals]),s=new Uint32Array(a.indices);Ae(s,i.matIndices,4);const c=new Uint32Array(i.lightIndices),l=new Float32Array(i.materials.reduce((v,g)=>[...v,...B([g.color,g.specular,g.emission,u(g.illum,g.shininess,g.ior)])],[])),{bindGroup:h}=z(n,r,[o,s,c],"STORAGE"),{bindGroup:f}=z(n,r,[a.bspPlanes,a.bspTree,a.treeIds],"STORAGE",1),{bindGroup:d}=z(n,r,[a.aabb,new Uint32Array([c.length])],"UNIFORM",2),{bindGroup:_}=z(n,r,[l],"STORAGE",3);(()=>{const{pass:v,executePass:g}=un(n,e,mn.black);v.setPipeline(r),v.setBindGroup(0,h),v.setBindGroup(1,f),v.setBindGroup(2,d),v.setBindGroup(3,_),v.draw(4),g()})()},hc=(n,e)=>{const t=on("Using the Binary Space Partitioning tree"),r=an("No description yet"),i=tn(),a=en(wi),o=_n();i.append(a,o),n.append(t,r,i),e.push(uc)},dc=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,Li="cornell-glass",Ii="jittering-active-bsp-cb",vc=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Li),i=nn(n,[],t,dc,"triangle-strip"),a=ie(await $n("models/CornellBox.obj")),o=me(a),s=Ie([o.vertices,o.normals]),c=new Uint32Array(o.indices);Ae(c,a.matIndices,4);const l=new Uint32Array(a.lightIndices),h=new Float32Array(a.materials.reduce((A,x)=>[...A,...B([x.color,x.specular,x.emission,u(x.illum,x.shininess,x.ior)])],[])),{bindGroup:f}=z(n,i,[s,c,l],"STORAGE"),{bindGroup:d}=z(n,i,[o.bspPlanes,o.bspTree,o.treeIds],"STORAGE",1),{bindGroup:_,buffers:[m,v,g]}=z(n,i,[o.aabb,new Uint32Array([l.length]),new Uint32Array([36])],"UNIFORM",2),L=ir(r.height,6),{bindGroup:I}=z(n,i,[h,new Float32Array(B(L))],"STORAGE",3);An(Ii,A=>{const x=A?36:1;Gn(n,g,new Uint32Array([x]),0),w()},"checked");const w=()=>{const{pass:A,executePass:x}=un(n,e,mn.black);A.setPipeline(i),A.setBindGroup(0,f),A.setBindGroup(1,d),A.setBindGroup(2,_),A.setBindGroup(3,I),A.draw(4),x()};w()},_c=(n,e)=>{const t=on("Spicing things up"),r=an("No description yet"),i=tn(),a=en(Li),o=_n(),s=P(Qn(Ii,!0),"Jittering enabled",!1);o.append(s),i.append(a,o),n.append(t,r,i),e.push(vc)},mc=(n,e)=>{lc(n,e),hc(n,e),_c(n,e)},pc=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,Ai="cornell-progressive",Tt="progressive-enabled-cb",Si="select-shader-cb-progressive",bc=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Ai),i=G(Tt,"checked"),a=ie(await $n("models/CornellBoxWithBlocks.obj")),o=me(a),s=Ie([o.vertices,o.normals]),c=new Uint32Array(o.indices);Ae(c,a.matIndices,4);const l=new Uint32Array(a.lightIndices),h=new Float32Array(a.materials.reduce((m,v)=>[...m,...B([v.color,v.specular,v.emission,u(v.illum,v.shininess,v.ior)])],[])),f={"Simple progressive":pc,"Simple progressive with soft shadows":gc,"Complex progressive":xc},d={f:()=>{}},_=m=>{const{renderSrc:v,renderDst:g,blitPingPong:L}=Qe(n,r),I=n.createShaderModule({code:f[m]}),p=n.createRenderPipeline({layout:"auto",vertex:{module:I,entryPoint:"main_vs"},fragment:{module:I,entryPoint:"main_fs",targets:[{format:t},{format:"rgba32float"}]},primitive:{topology:"triangle-strip"}}),{bindGroup:w}=z(n,p,[s,c,l,h],"STORAGE"),{bindGroup:A}=z(n,p,[o.bspPlanes,o.bspTree,o.treeIds],"STORAGE",1),{bindGroup:x,buffers:[O,S,F]}=z(n,p,[o.aabb,new Uint32Array([l.length]),new Uint32Array([0,r.width,r.height])],"UNIFORM",2),E=n.createBindGroup({layout:p.getBindGroupLayout(3),entries:[{binding:0,resource:g.createView()}]});let V=0;const R=()=>{if(!i())return;V+=1,Gn(n,F,new Uint32Array([V]),0);const{pass:T,encoder:q}=un(n,e,mn.black,{otherColorAttachments:[{view:v.createView(),loadOp:"load",storeOp:"store"}]});T.setPipeline(p),T.setBindGroup(0,w),T.setBindGroup(1,A),T.setBindGroup(2,x),T.setBindGroup(3,E),T.draw(4),T.end(),L(q),n.queue.submit([q.finish()]),requestAnimationFrame(R)};d.f=()=>requestAnimationFrame(R),requestAnimationFrame(R)};_(An(Si,_)),An(Tt,()=>d.f(),"checked")},yc=(n,e)=>{const t=on("Progressive rendering, the basics"),r=an("No description yet"),i=tn(),a=en(Ai),o=_n(),s=P(Qn(Tt,!0),"Progressive rendering enabled",!1),c=P(Fn(Si,["Simple progressive","Simple progressive with soft shadows","Complex progressive"],"Complex progressive"),"Progressive shader type",!1);o.append(s,c),i.append(a,o),n.append(t,r,i),e.push(bc)},Ti=(n,e)=>{yc(n,e)},wc=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,jt="brdfs",Bt="progressive-enabled-cb-"+jt,Bi="brdf-color-picker",Lc=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(jt),i=G(Bt,"checked"),a=G(Bi),o=ie(await $n("models/CornellBox.obj")),s=me(o),c=Ie([s.vertices,s.normals]),l=new Uint32Array(s.indices);Ae(l,o.matIndices,4);const h=new Uint32Array(o.lightIndices),f=new Float32Array(o.materials.reduce((R,T)=>[...R,...B([T.color,T.specular,T.emission,u(T.illum,T.shininess,T.ior)])],[]));let{renderSrc:d,renderDst:_,blitPingPong:m}=Qe(n,r);const v=n.createShaderModule({code:wc}),g=n.createRenderPipeline({layout:"auto",vertex:{module:v,entryPoint:"main_vs"},fragment:{module:v,entryPoint:"main_fs",targets:[{format:t},{format:"rgba32float"}]},primitive:{topology:"triangle-strip"}}),{bindGroup:L}=z(n,g,[c,l,h,f],"STORAGE"),{bindGroup:I}=z(n,g,[s.bspPlanes,s.bspTree,s.treeIds],"STORAGE",1),{bindGroup:p,buffers:[w,A,x,O]}=z(n,g,[s.aabb,new Uint32Array([h.length]),new Uint32Array([0,r.width,r.height]),new Float32Array($e(de(a())))],"UNIFORM",2),S=n.createBindGroup({layout:g.getBindGroupLayout(3),entries:[{binding:0,resource:_.createView()}]});let F=0;const E=()=>{if(!i())return;V===!0&&(V=!1,F=0),F+=1,Gn(n,x,new Uint32Array([F]),0),W(n,O,new Float32Array($e(de(a()))),0);const{pass:R,encoder:T}=un(n,e,mn.black,{otherColorAttachments:[{view:d.createView(),loadOp:"load",storeOp:"store"}]});R.setPipeline(g),R.setBindGroup(0,L),R.setBindGroup(1,I),R.setBindGroup(2,p),R.setBindGroup(3,S),R.draw(4),R.end(),m(T),n.queue.submit([T.finish()]),requestAnimationFrame(E)};An(Bt,R=>{R&&requestAnimationFrame(E)},"checked");let V=!1;Mt("restart-progressive-brdf",()=>V=!0),E()},Ic=(n,e)=>{const t=on("Progressive rendering, the basics"),r=an("No description yet"),i=tn(),a=en(jt),o=_n(),s=P(Qn(Bt,!0),"Progressive rendering enabled",!1),c=P(He(Bi,"#1a3205"),"Sphere extinction coefficient"),l=Ft("restart-progressive-brdf","Restart progressive");o.append(s,c,l),i.append(a,o),n.append(t,r,i),e.push(Lc)},Ri=(n,e)=>{Ic(n,e)},Ac=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
...
`,Nt="environmental",Rt="progressive-enabled-cb-"+Nt,Sc=async()=>{const{device:n,context:e,canvasFormat:t,canvas:r}=await cn(Nt),i=G(Rt,"checked"),a=G("environmental-texture-type"),{texture:o,sampler:s}=await Ye(n,"textures/luxo_pxr_campus.jpg"),{texture:c,sampler:l}=await Ye(n,"textures/luxo_pxr_campus.hdr.png"),h=ie(await $n("models/teapot.obj",1)),f=me(h),d=Ie([f.vertices,f.normals]),_=new Uint32Array(f.indices);Ae(_,h.matIndices,4);const m=new Float32Array(h.materials.reduce((C,$)=>[...C,...B([$.color,$.specular,$.emission,u($.illum,$.shininess,$.ior)])],[]));let{renderSrc:v,renderDst:g,blitPingPong:L}=Qe(n,r);const I=n.createShaderModule({code:Ac}),p=n.createRenderPipeline({layout:"auto",vertex:{module:I,entryPoint:"main_vs"},fragment:{module:I,entryPoint:"main_fs",targets:[{format:t},{format:"rgba32float"}]},primitive:{topology:"triangle-strip"}}),{bindGroup:w}=z(n,p,[d,_,m],"STORAGE"),{bindGroup:A}=z(n,p,[f.bspPlanes,f.bspTree,f.treeIds],"STORAGE",1),{bindGroup:x,buffers:[O,S,F,E,V]}=z(n,p,[f.aabb,new Uint32Array([0,r.width,r.height]),new Uint32Array([3,0,0,0]),new Float32Array([1,0,0,0]),new Uint32Array([0,0,0,0])],"UNIFORM",2),R=n.createBindGroup({layout:p.getBindGroupLayout(3),entries:[{binding:0,resource:g.createView()},{binding:1,resource:l},{binding:2,resource:c.createView()}]}),T=n.createBindGroup({layout:p.getBindGroupLayout(3),entries:[{binding:0,resource:g.createView()},{binding:1,resource:s},{binding:2,resource:o.createView()}]});let q=0;const rn=()=>{if(!i())return;X===!0&&(X=!1,q=0),q+=1,Gn(n,S,new Uint32Array([q]),0);const{pass:C,encoder:$}=un(n,e,mn.black,{otherColorAttachments:[{view:v.createView(),loadOp:"load",storeOp:"store"}]});C.setPipeline(p),C.setBindGroup(0,w),C.setBindGroup(1,A),C.setBindGroup(2,x),C.setBindGroup(3,a()==="High dynamic range"?R:T),C.draw(4),C.end(),L($),n.queue.submit([$.finish()]),requestAnimationFrame(rn)};An(Rt,C=>{C&&requestAnimationFrame(rn)},"checked");const sn=C=>{const $={"Base color":3,Lambertian:0,Mirror:1}[C];Gn(n,F,new Uint32Array([$]),0)};sn(An("model-shader-select-env",sn));const U=C=>{W(n,E,new Float32Array([C?1:0,0,0,0]),0)};U(An("include-sunlight",U,"checked"));const Y=C=>{const $=C==="High dynamic range"?1:0;Gn(n,V,new Uint32Array([$]),0)};Y(An("environmental-texture-type",Y));let X=!1;Mt("restart-progressive-env",()=>X=!0),rn()},Tc=(n,e)=>{const t=on("env"),r=an("No description yet"),i=tn(),a=en(Nt),o=_n(),s=P(Qn(Rt,!0),"Progressive rendering enabled",!1),c=P(Fn("model-shader-select-env",["Base color","Lambertian","Mirror"],"Lambertian"),"Model shader type",!1),l=P(Qn("include-sunlight",!0),"Sun light on",!1),h=P(Fn("environmental-texture-type",["Low dynamic range","High dynamic range"],"Low dynamic range"),"Environmental texture type",!1),f=Ft("restart-progressive-env","Restart progressive");o.append(s,c,l,h,f),i.append(a,o),n.append(t,r,i),e.push(Sc)},Pi=(n,e)=>{Tc(n,e)},Bc=`struct VertexNormal {
    vertex : vec3f,
    normal : vec3f
};
